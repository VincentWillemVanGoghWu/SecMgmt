...
#endif
static map<CString, unsigned long> mAlarmPics;
...
// 解决带百分号字符，打印错乱问题
bool FormatPrintPercent(const char* pSrc, int iSrcLen, char* pDst, int iDstLen)
{
    bool bFlag = true;
    for (int i = 0, j = 0; i < iSrcLen; i++)
    {
        if (j >= iDstLen)
        {
            bFlag = false;
...
int GetFileNum(int iDeviceIndex, long lCommand)
{
    char szKey[128] = { 0 };
    sprintf(szKey, "%s_%d", g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, lCommand);

    int num = mAlarmPics[szKey] / 1000 + 1;
    mAlarmPics[szKey]++;
    return num;
}
...
void AlarmMessage(LONG lCommand, NET_DVR_ALARMER *pAlarmer, char *pAlarmInfo, DWORD dwBufLen)
{
    ...
    {
        char szDeviceName[NAME_LEN + 1] = { 0 };
    ...
    try
    {
        ...
        if (lCommand == COMM_ISAPI_ALARM)
        {
            ...
            if (((LPNET_DVR_ALARM_ISAPI_INFO)pAlarmInfo)->byPicturesNumber != 0 && ((LPNET_DVR_ALARM_ISAPI_INFO)pAlarmInfo)->pPicPackData != NULL)
            {
        ...
        else if (COMM_UPLOAD_FACESNAP_RESULT == lCommand)
        {
            ...
            if ((((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer !=NULL) && ((LPNET_VCA_FACESNAP_ADDINFO)((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer)->dwThermalPicLen > 0)
            {
                ((LPNET_VCA_FACESNAP_ADDINFO)((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer)->pThermalPicBuff = (BYTE*)pAlarmMsg + sizeof(NET_VCA_FACESNAP_RESULT) + dwPrePicLen;
                dwPrePicLen += ((LPNET_VCA_FACESNAP_ADDINFO)((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer)->dwThermalPicLen;
            }

            if ((((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer != NULL) && ((LPNET_VCA_FACESNAP_ADDINFO)((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer)->dwEventNotificationAlertLen > 0)
            {
                ((LPNET_VCA_FACESNAP_ADDINFO)((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer)->pEventNotificationAlertBuff = (char*)pAlarmMsg + sizeof(NET_VCA_FACESNAP_RESULT) + dwPrePicLen;
                dwPrePicLen += ((LPNET_VCA_FACESNAP_ADDINFO)((LPNET_VCA_FACESNAP_RESULT)pAlarmMsg)->pAddInfoBuffer)->dwEventNotificationAlertLen;
            }
        ...
        else if (COMM_SNAP_MATCH_ALARM == lCommand)
        {
            ...
            if (((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwBlockListPicLen > 0)
            {
                ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pBuffer1 = new BYTE[((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwBlockListPicLen];
                memset(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pBuffer1, 0, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwBlockListPicLen);
                memcpy(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pBuffer1, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmInfo)->struBlockListInfo.pBuffer1, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwBlockListPicLen);
            }
            ...
            if (((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen > 0)
            {
                ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend = new BYTE[((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen];
                memset(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend, 0, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen);
                memcpy(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmInfo)->struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen);
            }
            ...
            if (((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwFDIDLen > 0)
            {
                ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pFDID = new BYTE[((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwFDIDLen];
                memset(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pFDID, 0, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwFDIDLen);
                memcpy(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pFDID, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmInfo)->struBlockListInfo.pFDID, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwFDIDLen);
            }

            if (((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwPIDLen > 0)
            {
                ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pPID = new BYTE[((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwPIDLen];
                memset(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pPID, 0, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwPIDLen);
                memcpy(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.pPID, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmInfo)->struBlockListInfo.pPID, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.dwPIDLen);
            }

            if (((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFDDescriptionLen > 0)
            {
                ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer = new BYTE[((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFDDescriptionLen];
                memset(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer, 0, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFDDescriptionLen);
                memcpy(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmInfo)->struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFDDescriptionLen);
            }

            if (((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen > 0)
            {
                ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer = new BYTE[((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen];
                memset(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer, 0, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen);
                memcpy(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmInfo)->struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen);
            }

            if (((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwThermalDataLen > 0)
            {
                ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.pThermalData = new BYTE[((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwThermalDataLen];
                memset(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.pThermalData, 0, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwThermalDataLen);
                memcpy(((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.struAttribute.pThermalData, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmInfo)->struBlockListInfo.struBlockListInfo.struAttribute.pThermalData, ((LPNET_VCA_FACESNAP_MATCH_ALARM)pAlarmMsg)->struBlockListInfo.struBlockListInfo.dwThermalDataLen);
            }
        }
        ...
        else if (COMM_ALARM_SHIPSDETECTION == lCommand)
        {
            ...
            ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->pXmlBuf = new char[((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->dwXmlLen];
            memset(((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->pXmlBuf, 0, ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->dwXmlLen);
            memcpy(((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->pXmlBuf, ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmInfo)->pXmlBuf, ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->dwXmlLen);

            for (int i = 0; i < MAX_SHIPIMAGE_NUM; i++)
            {
                ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->struShipImageInfo[i].pXmlBuf = new char[((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->struShipImageInfo[i].dwShipImageLen];
                memset(((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->struShipImageInfo[i].pXmlBuf, 0, ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->struShipImageInfo[i].dwShipImageLen);
                memcpy(((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->struShipImageInfo[i].pXmlBuf, ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmInfo)->struShipImageInfo[i].pXmlBuf, ((LPNET_DVR_SHIPSDETECTION_ALARM)pAlarmMsg)->struShipImageInfo[i].dwShipImageLen);
            }
        }
        ...
        else if (COMM_ALARM_TPS_STATISTICS == lCommand)
        {
            if (((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmMsg)->byJsonInfoFlag > 0)
            {
                ((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmMsg)->pJsonBuf = new BYTE[((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmMsg)->dwJsonLen];
                memset(((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmMsg)->pJsonBuf, 0, ((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmMsg)->dwJsonLen);
                memcpy(((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmMsg)->pJsonBuf, ((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmInfo)->pJsonBuf, ((LPNET_DVR_TPS_STATISTICS_INFO)pAlarmMsg)->dwJsonLen);
            }
        }
        ...
        else if (COMM_PLATE_RESULT_V50 == lCommand)
        {
            ...
            if (((LPNET_DVR_PLATE_RESULT_V50)pAlarmMsg)->struPlateInfo.dwXmlLen > 0)
            {
                ((LPNET_DVR_PLATE_RESULT_V50)pAlarmMsg)->struPlateInfo.pXmlBuf = (char*)pAlarmMsg + sizeof(NET_DVR_PLATE_RESULT_V50) + dwPrePicLen;
                dwPrePicLen += ((LPNET_DVR_PLATE_RESULT_V50)pAlarmMsg)->struPlateInfo.dwXmlLen;
            }
        }
        ...
        else if (COMM_ALARM_TFS == lCommand)
        {
            ...
            //赋值xml报文
            if ((((LPNET_DVR_TFS_ALARM)pAlarmMsg)->dwXmlLen) > 0)
            {
                ((LPNET_DVR_TFS_ALARM)pAlarmMsg)->pXmlBuf = (char *)pAlarmMsg + sizeof(NET_DVR_TFS_ALARM) + dwPrePicLen;
            }
        }
        ...
        else if (COMM_ALARM_V40 == lCommand)
        {
            ...
            DWORD dwVerDataLength = 0;
            DWORD dwPicDataLength = 0;
            ...
            case 28:
                ...
                dwPicDataLength = ((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struAlarmChannel.dwPicLen;
                break;
            case 32:
                dwVerDataLength = ((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struPTLocking.dwCustomInfoLength;
                break;
            default:
                dwVerDataNum = 0;
                dwVerDataLength = 0;
            ...
            if (dwVerDataLength != 0)
            {
                ((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo = new BYTE[dwVerDataLength];
                memset(((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo, 0, dwVerDataLength);
                memcpy(((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo, ((LPNET_DVR_ALARMINFO_V40)pAlarmInfo)->struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo, dwVerDataLength);

            }
            else if (dwVerDataNum != 0)
            {
            ...
            if (dwPicDataLength != 0)
            {
                ((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff = new char[dwPicDataLength];
                memset(((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff, 0, dwPicDataLength);
                memcpy(((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff, ((LPNET_DVR_ALARMINFO_V40)pAlarmInfo)->struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff, dwPicDataLength);
            }
            else if (((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.dwAlarmType==32)
            {
                ((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->pAlarmData = NULL;
                ((LPNET_DVR_ALARMINFO_V40)pAlarmMsg)->struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo = NULL;
            }
        ...
        {
            if (((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->dwPicDataLen > 0 && ((LPNET_DVR_ACS_ALARM_INFO)pAlarmInfo)->pPicData != NULL)
            {
            ...
            if (((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->byAcsEventInfoExtendV20 == 1 && ((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->pAcsEventInfoExtendV20 != NULL)
            {
                ((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->pAcsEventInfoExtendV20 = new char[sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND_V20)];
                LPNET_DVR_ACS_EVENT_INFO_EXTEND_V20 m_pAcsEventInfoExtendV20 = LPNET_DVR_ACS_EVENT_INFO_EXTEND_V20(((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->pAcsEventInfoExtendV20);

                memset(m_pAcsEventInfoExtendV20, 0, sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND_V20));
                memcpy(m_pAcsEventInfoExtendV20, ((LPNET_DVR_ACS_ALARM_INFO)pAlarmInfo)->pAcsEventInfoExtendV20, sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND_V20));
                ...
                if (m_pAcsEventInfoExtendV20->dwQRCodeInfoLen > 0 && m_pAcsEventInfoExtendV20->pQRCodeInfo != NULL)
                {
                    m_pAcsEventInfoExtendV20->pQRCodeInfo = new char[m_pAcsEventInfoExtendV20->dwQRCodeInfoLen];
                    memset(m_pAcsEventInfoExtendV20->pQRCodeInfo, 0, m_pAcsEventInfoExtendV20->dwQRCodeInfoLen);
                    memcpy(m_pAcsEventInfoExtendV20->pQRCodeInfo, (LPNET_DVR_ACS_EVENT_INFO_EXTEND_V20(pAlarmInfo + sizeof(NET_DVR_ACS_ALARM_INFO)+sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND)))->pQRCodeInfo, m_pAcsEventInfoExtendV20->dwQRCodeInfoLen);
                }
                if (m_pAcsEventInfoExtendV20->dwVisibleLightDataLen > 0 && m_pAcsEventInfoExtendV20->pVisibleLightData != NULL)
                {
                    m_pAcsEventInfoExtendV20->pVisibleLightData = new char[m_pAcsEventInfoExtendV20->dwVisibleLightDataLen];
                    memset(m_pAcsEventInfoExtendV20->pVisibleLightData, 0, m_pAcsEventInfoExtendV20->dwVisibleLightDataLen);
                    memcpy(m_pAcsEventInfoExtendV20->pVisibleLightData, (LPNET_DVR_ACS_EVENT_INFO_EXTEND_V20(pAlarmInfo + sizeof(NET_DVR_ACS_ALARM_INFO)+sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND)))->pVisibleLightData, m_pAcsEventInfoExtendV20->dwVisibleLightDataLen);
                }
                if (m_pAcsEventInfoExtendV20->dwThermalDataLen > 0 && m_pAcsEventInfoExtendV20->pThermalData != NULL)
                {
                    m_pAcsEventInfoExtendV20->pThermalData = new char[m_pAcsEventInfoExtendV20->dwThermalDataLen];
                    memset(m_pAcsEventInfoExtendV20->pThermalData, 0, m_pAcsEventInfoExtendV20->dwThermalDataLen);
                    memcpy(m_pAcsEventInfoExtendV20->pThermalData, (LPNET_DVR_ACS_EVENT_INFO_EXTEND_V20(pAlarmInfo + sizeof(NET_DVR_ACS_ALARM_INFO)+sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND)))->pThermalData, m_pAcsEventInfoExtendV20->dwThermalDataLen);
                }
            }
            else if (((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->byAcsEventInfoExtend == 1 && ((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->pAcsEventInfoExtend != NULL)
            {
                ((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->pAcsEventInfoExtend = new char[sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND)];
                memset(((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->pAcsEventInfoExtend, 0, sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND));
                memcpy(((LPNET_DVR_ACS_ALARM_INFO)pAlarmMsg)->pAcsEventInfoExtend, ((LPNET_DVR_ACS_ALARM_INFO)pAlarmInfo)->pAcsEventInfoExtend, sizeof(NET_DVR_ACS_EVENT_INFO_EXTEND));
        ...
        {
            if (((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->byIDCardInfoExtend == 1 && ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->pIDCardInfoExtend != NULL)
            {
                ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->pIDCardInfoExtend = new char[sizeof(NET_DVR_ID_CARD_INFO_EXTEND)];
                LPNET_DVR_ID_CARD_INFO_EXTEND m_pIDCardInfoExtend = LPNET_DVR_ID_CARD_INFO_EXTEND(((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->pIDCardInfoExtend);

                memset(m_pIDCardInfoExtend, 0, sizeof(NET_DVR_ID_CARD_INFO_EXTEND));
                memcpy(m_pIDCardInfoExtend, ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmInfo)->pIDCardInfoExtend, sizeof(NET_DVR_ID_CARD_INFO_EXTEND));

                if (m_pIDCardInfoExtend->dwQRCodeInfoLen > 0 && m_pIDCardInfoExtend->pQRCodeInfo != NULL)
                {
                    m_pIDCardInfoExtend->pQRCodeInfo = new char[m_pIDCardInfoExtend->dwQRCodeInfoLen];
                    memset(m_pIDCardInfoExtend->pQRCodeInfo, 0, m_pIDCardInfoExtend->dwQRCodeInfoLen);
                    memcpy(m_pIDCardInfoExtend->pQRCodeInfo, (LPNET_DVR_ID_CARD_INFO_EXTEND(pAlarmInfo + sizeof(NET_DVR_ID_CARD_INFO_ALARM)))->pQRCodeInfo, m_pIDCardInfoExtend->dwQRCodeInfoLen);
                }

                if (m_pIDCardInfoExtend->dwVisibleLightDataLen > 0 && m_pIDCardInfoExtend->pVisibleLightData != NULL)
                {
                    m_pIDCardInfoExtend->pVisibleLightData = new char[m_pIDCardInfoExtend->dwVisibleLightDataLen];
                    memset(m_pIDCardInfoExtend->pVisibleLightData, 0, m_pIDCardInfoExtend->dwVisibleLightDataLen);
                    memcpy(m_pIDCardInfoExtend->pVisibleLightData, (LPNET_DVR_ID_CARD_INFO_EXTEND(pAlarmInfo + sizeof(NET_DVR_ID_CARD_INFO_ALARM)))->pVisibleLightData, m_pIDCardInfoExtend->dwVisibleLightDataLen);
                }

                if (m_pIDCardInfoExtend->dwThermalDataLen > 0 && m_pIDCardInfoExtend->pThermalData != NULL)
                {
                    m_pIDCardInfoExtend->pThermalData = new char[m_pIDCardInfoExtend->dwThermalDataLen];
                    memset(m_pIDCardInfoExtend->pThermalData, 0, m_pIDCardInfoExtend->dwThermalDataLen);
                    memcpy(m_pIDCardInfoExtend->pThermalData, (LPNET_DVR_ID_CARD_INFO_EXTEND(pAlarmInfo + sizeof(NET_DVR_ID_CARD_INFO_ALARM)))->pThermalData, m_pIDCardInfoExtend->dwThermalDataLen);
                }
            }

            if (((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->dwPicDataLen > 0 && ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmInfo)->pPicData != NULL)
            {
            ...
            if ((((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->dwFingerPrintDataLen > 0) && (((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmInfo)->pFingerPrintData != NULL))
            {
            ...
            if ((((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->dwCapturePicDataLen > 0) && (((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmInfo)->pCapturePicData != NULL))
            {
            ...
            if ((((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->dwCertificatePicDataLen > 0) && (((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmInfo)->pCertificatePicData != NULL))
            {
                ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->pCertificatePicData = new char[((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->dwCertificatePicDataLen];
                memset(((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->pCertificatePicData, 0, ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->dwCertificatePicDataLen);
                memcpy(((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->pCertificatePicData, ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmInfo)->pCertificatePicData, ((LPNET_DVR_ID_CARD_INFO_ALARM)pAlarmMsg)->dwCertificatePicDataLen);
            }
        }
        ...
        else if (COMM_UPLOAD_HEATMAP_RESULT_PDC == lCommand)
        {
            ...
            if (((LPNET_DVR_HEATMAP_RESULT_PDC)pAlarmMsg)->pEventNotificationAlertBuff != NULL && ((LPNET_DVR_HEATMAP_RESULT_PDC)pAlarmMsg)->dwEventNotificationAlertLen > 0)
            {
                ((LPNET_DVR_HEATMAP_RESULT_PDC)pAlarmMsg)->pEventNotificationAlertBuff = (char*)pAlarmMsg + sizeof(NET_DVR_HEATMAP_RESULT_PDC) + iLen;
                iLen += ((LPNET_DVR_HEATMAP_RESULT_PDC)pAlarmMsg)->dwEventNotificationAlertLen;
            }
        }
        ...
        else if (COMM_VCA_ATTEND_ALARM == lCommand)
        {
            for (int i = 0; i < ((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.byPicNum; i++)
            {
                DWORD dwPicLen = ((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.struPicData[i].dwPicLen;
                if (dwPicLen > 0)
                {
                    ((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.struPicData[i].pPicBuf = new char[dwPicLen];
                    if (((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.struPicData[i].pPicBuf != NULL)
                    {
                        memcpy(((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.struPicData[i].pPicBuf, ((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmInfo)->struPicInfo.struPicData[i].pPicBuf, dwPicLen);
                    }
                }
            }
            DWORD dwVideoLen = ((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.dwVideoLen;
            if (dwVideoLen > 0)
            {
                ((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.pVideoBuf = new char[dwVideoLen];
                if (((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.pVideoBuf != NULL)
                {
                    memcpy(((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmMsg)->struPicInfo.pVideoBuf, ((LPNET_DVR_VCA_ATTEND_ALARM_INFO)pAlarmInfo)->struPicInfo.pVideoBuf, dwVideoLen);
                }
            }
        }
        else if (COMM_UPLOAD_AIOP_VIDEO == lCommand)
        {
            ...
            if (((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwAddInfoPictureSize > 0 && ((LPNET_AIOP_VIDEO_HEAD)pAlarmInfo)->pAddInfoPictureBuffer != NULL)
            {
                ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->pAddInfoPictureBuffer = (BYTE *)pAlarmMsg + sizeof(NET_AIOP_VIDEO_HEAD) + dwPrePicLen;
                dwPrePicLen += ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwAddInfoPictureSize;
            }
            if (((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwFacePicBuffLen > 0 && ((LPNET_AIOP_VIDEO_HEAD)pAlarmInfo)->pFacePicBuff != NULL)
            {
                ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->pFacePicBuff = (char*)((BYTE *)pAlarmMsg + sizeof(NET_AIOP_VIDEO_HEAD) + dwPrePicLen);
                dwPrePicLen += ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwFacePicBuffLen;
            }
            if (((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwComparisonPicBuffLen > 0 && ((LPNET_AIOP_VIDEO_HEAD)pAlarmInfo)->pComparisonPicBuff != NULL)
            {
                ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->pComparisonPicBuff = (char*)((BYTE *)pAlarmMsg + sizeof(NET_AIOP_VIDEO_HEAD) + dwPrePicLen);
                dwPrePicLen += ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwComparisonPicBuffLen;
            }
            if (((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwCompressedDotMatrixBuffLen > 0 && ((LPNET_AIOP_VIDEO_HEAD)pAlarmInfo)->pCompressedDotMatrixBuff != NULL)
            {
                ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->pCompressedDotMatrixBuff = (char*)((BYTE *)pAlarmMsg + sizeof(NET_AIOP_VIDEO_HEAD) + dwPrePicLen);
                dwPrePicLen += ((LPNET_AIOP_VIDEO_HEAD)pAlarmMsg)->dwCompressedDotMatrixBuffLen;
            }
        }
        else if (COMM_UPLOAD_AIOP_PICTURE == lCommand)
        {
            ...
            if (((LPNET_AIOP_PICTURE_HEAD)pAlarmMsg)->dwPictureSize > 0 && ((LPNET_AIOP_PICTURE_HEAD)pAlarmInfo)->pBufferPicture != NULL)
            {
                ((LPNET_AIOP_PICTURE_HEAD)pAlarmMsg)->pBufferPicture = (BYTE *)pAlarmMsg + sizeof(NET_AIOP_PICTURE_HEAD) + ((LPNET_AIOP_PICTURE_HEAD)pAlarmInfo)->dwAIOPDataSize;
            }
            if (((LPNET_AIOP_PICTURE_HEAD)pAlarmMsg)->dwCompressedDotMatrixBuffLen > 0 && ((LPNET_AIOP_PICTURE_HEAD)pAlarmInfo)->pCompressedDotMatrixBuff != NULL)
            {
                ((LPNET_AIOP_PICTURE_HEAD)pAlarmMsg)->pCompressedDotMatrixBuff = (char*)(BYTE *)pAlarmMsg + sizeof(NET_AIOP_PICTURE_HEAD) + ((LPNET_AIOP_PICTURE_HEAD)pAlarmInfo)->dwAIOPDataSize + ((LPNET_AIOP_PICTURE_HEAD)pAlarmInfo)->dwPictureSize;
            }
        }
        else if (COMM_UPLOAD_AIOP_POLLING_SNAP == lCommand)
        {
            ...
            if (((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmMsg)->dwAddInfoPictureSize > 0 && ((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmInfo)->pAddInfoPictureBuffer != NULL)
            {
                ((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmMsg)->pAddInfoPictureBuffer = (BYTE *)pAlarmMsg + sizeof(NET_AIOP_POLLING_SNAP_HEAD) + dwDataLen;
                dwDataLen += ((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmMsg)->dwAddInfoPictureSize;
            }
            if (((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmMsg)->dwCompressedDotMatrixBuffLen > 0 && ((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmInfo)->pCompressedDotMatrixBuff != NULL)
            {
                ((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmMsg)->pCompressedDotMatrixBuff = (char *)pAlarmMsg + sizeof(NET_AIOP_POLLING_SNAP_HEAD) + dwDataLen;
                dwDataLen += ((LPNET_AIOP_POLLING_SNAP_HEAD)pAlarmMsg)->dwCompressedDotMatrixBuffLen;
            }
        }
        else if (COMM_UPLOAD_AIOP_POLLING_VIDEO == lCommand)
        {
            ...
            if (((LPNET_AIOP_POLLING_VIDEO_HEAD)pAlarmMsg)->dwCompressedDotMatrixBuffLen > 0 && ((LPNET_AIOP_POLLING_VIDEO_HEAD)pAlarmInfo)->pCompressedDotMatrixBuff != NULL)
            {
                ((LPNET_AIOP_POLLING_VIDEO_HEAD)pAlarmMsg)->pCompressedDotMatrixBuff = (char*)pAlarmMsg + sizeof(NET_AIOP_POLLING_VIDEO_HEAD) + dwDataLen;
                dwDataLen += ((LPNET_AIOP_POLLING_VIDEO_HEAD)pAlarmMsg)->dwCompressedDotMatrixBuffLen;
            }
        }
		else if (COMM_UPLOAD_AIOP_HISTORY_VIDEO == lCommand)
		{
			DWORD dwDataLen = 0;
			if (((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmMsg)->dwAIOPDataSize > 0 && ((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmInfo)->pBufferAIOPData != NULL)
			{
				((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmMsg)->pBufferAIOPData = (BYTE*)pAlarmMsg + sizeof(NET_AIOP_HISTORY_VIDEO_HEAD) + dwDataLen;
				dwDataLen += ((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmMsg)->dwAIOPDataSize;
			}
			if (((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmMsg)->dwPictureSize > 0 && ((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmInfo)->pBufferPicture != NULL)
			{
				((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmMsg)->pBufferPicture = (BYTE*)pAlarmMsg + sizeof(NET_AIOP_HISTORY_VIDEO_HEAD) + dwDataLen;
				dwDataLen += ((LPNET_AIOP_HISTORY_VIDEO_HEAD)pAlarmMsg)->dwPictureSize;
			}
		}
...
void CALLBACK MessageCallback(LONG lCommand, NET_DVR_ALARMER *pAlarmer, char *pAlarmInfo, DWORD dwBufLen, void* pUser)
{
    //Sleep(100000);
    UNREFERENCED_PARAMETER(pUser);
    if (lCommand == COMM_CHILD_DEVICE_ALARM)
    {
        BYTE byChildDeviceID[33] = { 0 };
        NET_DVR_CHILD_DEVICE_ALARM *pAlarm = (NET_DVR_CHILD_DEVICE_ALARM *)pAlarmInfo;
        memcpy(byChildDeviceID, pAlarm->struChildDevHead.szChildDeviceID, 32);
        g_pMainDlg->AddLog(-1, ALARM_INFO_T, "alarm host get alarm[%x] from child device[%s] channel[%d]", lCommand, byChildDeviceID, pAlarm->struChildDevHead.dwChannel);
        AlarmMessage(pAlarm->dwCommand, pAlarmer, (char*)pAlarm->pAlarmInfo, pAlarm->dwAlarmLen);
    }
    else
    {
...
ON_COMMAND(ID_MENU_KEYLOG, OnMenuKeylog)
	//}}AFX_MSG_MAP
...
void CClientDemoDlg::StartPlayAll(void)
{
	...
	//get and save all VideoSecurity points that can be previewed
	int i = 0;
	int j = 0;
	int iFirstPlayNum = 0;//first VideoSecurity point
	int iDeviceIndex = -1;
	int iChanIndex = -1;
	int iVideoSecurityNumLeft = 0;
	g_nVideoSecurityTotalNum = 0;

	//get current VideoSecurity to play
	for (i = 0; i < MAX_DEVICES; i++)
	{
        ...
        if ((-1 != g_struDeviceInfo[i].iDeviceChanNum || g_struDeviceInfo[i].byURL) &&  g_struDeviceInfo[i].lLoginID != -1)
		{
			...
			{	
				if (g_struDeviceInfo[i].pStruChanInfo[j].bEnable)
				{
					g_struPlayAllInfo[g_nVideoSecurityTotalNum].iDeviceIndex = i;//serial starts from 0
					g_struPlayAllInfo[g_nVideoSecurityTotalNum].iChanIndex = j;
					g_nVideoSecurityTotalNum ++;
				}
			}
		}
	}
	
    if (g_nVideoSecurityTotalNum == 0)
	{
		return;//no monitoring points that can be played
	}

	AddLog(m_iCurDeviceIndex, OPERATION_SUCC_T, "StartPlayAll:Total Chan Number= %d", g_nVideoSecurityTotalNum);
	
	if (g_nVideoSecurityTotalNum > m_iCurWndNum)
	{//first group of mornitoring points
		iFirstPlayNum = m_iCurWndNum;
		iVideoSecurityNumLeft = g_nVideoSecurityTotalNum - m_iCurWndNum;
		g_iNextVideoSecurityIndex = m_iCurWndNum;
		g_struLocalParam.bNextPage = TRUE;
		g_struLocalParam.bFrontPage =FALSE ;
	}
	else//only one group
	{
		iFirstPlayNum = g_nVideoSecurityTotalNum;
		iVideoSecurityNumLeft = 0;
		g_iNextVideoSecurityIndex = g_nVideoSecurityTotalNum;
		g_struLocalParam.bFrontPage = FALSE;
	...
	for (i = 0; i < iFirstPlayNum; i++)
	{
        ...
        //没有通道设置了URL方式预览
        if (g_struDeviceInfo[iDeviceIndex].byURL && g_nVideoSecurityTotalNum == 1)
        {
...
//        struLoginInfo.byVerifyMode = 2;
        ...
        else
        {
            ...
            g_struDeviceInfo[iDeviceIndex].byMarketType = struDeviceInfoV40.byMarketType;
            if (g_struDeviceInfo[iDeviceIndex].byMarketType == 1)
            {
                char szLan[128] = { 0 };
                g_StringLanType(szLan, "经销型设备", "Distribution Type");
                g_pMainDlg->AddLog(-1, OPERATION_SUCC_T, szLan);
            }
            else if(g_struDeviceInfo[iDeviceIndex].byMarketType == 2)
            {
                char szLan[128] = { 0 };
                g_StringLanType(szLan, "行业型设备", "Industry Type");
                g_pMainDlg->AddLog(-1, OPERATION_SUCC_T, szLan);
            }
...
// 	    NET_DVR_SetTransparentParam(lUserID, (char*)strContent.c_str(), strContent.size());
        ...
        NET_DVR_DEVICECFG_V40 struDevCFGV40 = { 0 };
        if (!NET_DVR_GetDVRConfig(lUserID, NET_DVR_GET_DEVICECFG_V40, 0, &struDevCFGV40, sizeof(NET_DVR_DEVICECFG_V40), &dwReturned))
        {
            int nError = NET_DVR_GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "NET_DVR_GET_DEV_LOGIN_RET_INFO");
        }
        ...
        string m = (char*)struDevCFGV40.byDevTypeName;
...
void CClientDemoDlg::ProcAlarmV40(WPARAM wParam, LPARAM lParam)
{
    ...
    case 3://motion detection alarm
        ...
        if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.byTarget > 0)
        {
            sprintf(szInfoBuf, "%s Target[%d]", szInfoBuf, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.byTarget);
        }

        if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.dwPicLen > 0 && m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff != NULL)
        {
            SYSTEMTIME t;
            GetLocalTime(&t);
            char chTime[128];
            ...
            DWORD dwAlarmChan = iAChanNum;
            if (pContent != NULL && m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.dwAlarmChanNum > 0)
            {
                dwAlarmChan = *(pContent);
            }

            sprintf(cFilename, "%s\\%s[%d][%d]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, dwAlarmChan);
            if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
            {
                CreateDirectory(cFilename, NULL);
            }

            // 区分target 0-不支持,1-人,2-车
            char szType[16] = { 0 };
            if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.byTarget == 1)
            {
                g_StringLanType(szType, "人", "hunman");
            }
            else if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.byTarget == 2)
            {
                g_StringLanType(szType, "车", "vehicle");
            }
            else
            {
                g_StringLanType(szType, "未知", "unknown");
            }

            if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.byPicURL == 1)
            {
                sprintf(cFilename, "%s\\[%s]LocalTime[%s]_%d.txt", cFilename, szType, chTime, rand() % GetTickCount());
            }
            else if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.byPicURL == 0)
            {
                sprintf(cFilename, "%s\\[%s]LocalTime[%s]_%d.jpg", cFilename, szType, chTime, rand() % GetTickCount());
            }
            ...
            DWORD dwRet = WriteFile(hFile, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.dwPicLen, &dwWrittenBytes, NULL);
            if (dwRet == 0 || dwWrittenBytes < m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.dwPicLen)
            {
                DWORD dwError = GetLastError();
                g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "DataBuff Wtite to File Fail.System Error:%d, CustomInfoLength:%d, pBuffer:%d ", dwError, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.dwPicLen, dwWrittenBytes);
            }
            CloseHandle(hFile);
            hFile = NULL;
    ...
    case 32:
    {
        g_StringLanType(szLan, "云台堵转异常", "PTLocking");
        sprintf(szInfoBuf, "%s fTemperature[%.3f] dwCustomInfoLength[%d] byType[%d] byDeicingEnabled[%d] channel[%d]", szLan, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.fTemperature, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.dwCustomInfoLength, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.byType, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.byDeicingEnabled, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.dwChannel);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);

        if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.dwCustomInfoLength > 0 && m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo != NULL)
        {
            SYSTEMTIME t;
            GetLocalTime(&t);
            char chTime[128];
            ...
            char cFilename[256] = { 0 };
            DWORD dwWrittenBytes = 0;
            sprintf(cFilename, "%s\\%s[%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, "CustomInfo");
            if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
            {
                CreateDirectory(cFilename, NULL);
            }
            ...
            DWORD dwRet = WriteFile(hFile, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.dwCustomInfoLength, &dwWrittenBytes, NULL);
            if (dwRet == 0 || dwWrittenBytes < m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.dwCustomInfoLength)
            {
                DWORD dwError = GetLastError();
                g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "CustomInfo Wtite to File Fail.System Error:%d, CustomInfoLength:%d, pBuffer:%d ", dwError, m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.dwCustomInfoLength, dwWrittenBytes);
            }
            CloseHandle(hFile);
            hFile = NULL;
        }
    ...
    case 33:
    {
        g_StringLanType(szLan, "日志异常报警:", "Log Exception Alarm");

        char cExceptionType[64] = { 0 };
        switch (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struLogException.byExceptionType)
        {
        case 1:
            sprintf(cExceptionType, "%s", "日志存储异常");
            break;
        case 2:
            sprintf(cExceptionType, "%s", "日志盘满");
            break;
        default:
            break;
        }
        sprintf(szInfoBuf, "%s  异常类型[%s]", szLan, cExceptionType);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    }
    break;
    case 34:
    {
        g_StringLanType(szLan, "异常重启:", "Abnormal Reboot");

        char cExceptionType[64] = { 0 };
        switch (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAbnormalReboot.byExceptionType)
        {
        case 0: 
            g_StringLanType(cExceptionType, "异常类型[正常重启]", "Exception type[Normal restart]");
            break;
        case 1:
            g_StringLanType(cExceptionType, "异常类型[线程异常]", "Exception type[Thread exception]");
            break;
        case 2:
            g_StringLanType(cExceptionType, "异常类型[码流异常]", "Exception type[Stream exception]");
            break;
        default:
            g_StringLanType(cExceptionType, "异常类型[其他异常]", "Exception type[Other exception]");
            break;
        }
        sprintf(szInfoBuf, "%s %s", szLan, cExceptionType);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    }
    break;
	default:
    ...
    if (m_struAlarmInfoV40.struAlarmFixedHeader.dwAlarmType == 32)
    {
        if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo != NULL)
        {
            delete[](m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo);
            m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struPTLocking.pCustomInfo = NULL;
        }
    }

    if (m_struAlarmInfoV40.struAlarmFixedHeader.dwAlarmType == 3)
    {
        if (m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff != NULL)
        {
            delete[](m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff);
            m_struAlarmInfoV40.struAlarmFixedHeader.uStruAlarm.struAlarmChannel.pDataBuff = NULL;
        }
    }
}
...
void CClientDemoDlg::ProcPdcAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    if (!g_ValidIPv6((BYTE *)(g_struDeviceInfo[iDeviceIndex].chDeviceIP)))
    {
        sprintf(szIPAddress, "%s", struPDCAlarmInfo.struDevInfo.struDevIP.sIpV4);
    }
    else //ipv6
    {
        sprintf(szIPAddress, "%s", struPDCAlarmInfo.struDevInfo.struDevIP.byIPv6);
    }
    ...
    if (struPDCAlarmInfo.byMode == 0 )
    {
        ...
        sprintf(szInfoBuf, "Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d flag[%d] %2.2d%2.2d] Rel[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] \
            ...
            szIPAddress, struPDCAlarmInfo.struDevInfo.wPort, struPDCAlarmInfo.struDevInfo.byChannel,
    ...
    if (struPDCAlarmInfo.dwXmlLen > 0)
    {
        ...
        int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
...
void CClientDemoDlg::ProcRuleAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    NET_DVR_TIME struRelativeTime = { 0 };
    char szTime[128] = { 0 };
    int iTimeDifferenceH = 0;

    if (struVcaRuleAlarm.dwRelativeTime > 0)
    {
        ...
        if (struAbsTime.dwDay > struRelativeTime.dwDay)
        {
            iTimeDifferenceH = (struAbsTime.dwHour - struRelativeTime.dwHour) + (struAbsTime.dwDay - struRelativeTime.dwDay) * 24;
        }
        else if (struAbsTime.dwDay == struRelativeTime.dwDay)
        {
            iTimeDifferenceH = (struAbsTime.dwHour - struRelativeTime.dwHour);
        }
        else
        {
            iTimeDifferenceH = (struAbsTime.dwHour - struRelativeTime.dwHour) - (struAbsTime.dwDay - struRelativeTime.dwDay) * 24;
    ...
    if (iTimeDifferenceH >= 0)
    {
        sprintf(szTime, "VCA Alarm time flag[%d] Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d +%d]", struVcaRuleAlarm.byRelativeTimeFlag,
            struAbsTime.dwYear, struAbsTime.dwMonth, struAbsTime.dwDay, struAbsTime.dwHour, struAbsTime.dwMinute, struAbsTime.dwSecond,
            struRelativeTime.dwYear, struRelativeTime.dwMonth, struRelativeTime.dwDay, struRelativeTime.dwHour, struRelativeTime.dwMinute, struRelativeTime.dwSecond, iTimeDifferenceH);
    }
    else
    {
        sprintf(szTime, "VCA Alarm time flag[%d] Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d %d]", struVcaRuleAlarm.byRelativeTimeFlag,
    ...
    {
    case ENUM_VCA_EVENT_TRAVERSE_PLANE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_TRAVERSE_PLANE");
        break;
    case ENUM_VCA_EVENT_ENTER_AREA:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_ENTER_AREA");
        break;
    case ENUM_VCA_EVENT_EXIT_AREA:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_EXIT_AREA");
        break;
    case ENUM_VCA_EVENT_INTRUSION:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_INTRUSION");
        break;
    case ENUM_VCA_EVENT_LOITER:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_LOITER");
        break;
    case ENUM_VCA_EVENT_LEFT_TAKE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_LEFT_TAKE");
        break;
    case ENUM_VCA_EVENT_PARKING:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_PARKING");
        break;
    case ENUM_VCA_EVENT_RUN:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_RUN");
        break;
    case ENUM_VCA_EVENT_HIGH_DENSITY:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_HIGH_DENSITY");
        break;
    case ENUM_VCA_EVENT_VIOLENT_MOTION:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_VIOLENT_MOTION");
        break;
    case ENUM_VCA_EVENT_REACH_HIGHT:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_REACH_HIGHT");
        break;
    case ENUM_VCA_EVENT_GET_UP:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_GET_UP");
        break;
    case ENUM_VCA_EVENT_LEFT:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_LEFT");
        break;
    case ENUM_VCA_EVENT_TAKE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_TAKE");
        break;
    case ENUM_VCA_EVENT_LEAVE_POSITION:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_LEAVE_POSITION");
        break;
    case ENUM_VCA_EVENT_TRAIL:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_TRAIL");
        break;
    case ENUM_VCA_EVENT_KEY_PERSON_GET_UP:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_KEY_PERSON_GET_UP");
        break;
    case ENUM_VCA_EVENT_STANDUP:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_STANDUP");
        break;
    case ENUM_VCA_EVENT_FALL_DOWN:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_FALL_DOWN");
        break;
    case ENUM_VCA_EVENT_AUDIO_ABNORMAL:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_AUDIO_ABNORMAL");
        break;
    case ENUM_VCA_EVENT_ADV_REACH_HEIGHT:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_ADV_REACH_HEIGHT");
        break;
    case ENUM_VCA_EVENT_TOILET_TARRY:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_TOILET_TARRY");
        break;
    case ENUM_VCA_EVENT_YARD_TARRY:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_YARD_TARRY");
        break;
    case ENUM_VCA_EVENT_ADV_TRAVERSE_PLANE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_ADV_TRAVERSE_PLANE");
        break;
    case ENUM_VCA_EVENT_LECTURE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_LECTURE");
        break;
    case ENUM_VCA_EVENT_ANSWER:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_ANSWER");
        break;
    case ENUM_VCA_EVENT_HUMAN_ENTER:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_HUMAN_ENTER");
        break;
    case ENUM_VCA_EVENT_OVER_TIME:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_OVER_TIME");
        break;
    case ENUM_VCA_EVENT_STICK_UP:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_STICK_UP");
        break;
    case ENUM_VCA_EVENT_INSTALL_SCANNER:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_INSTALL_SCANNER");
        break;
    case ENUM_VCA_EVENT_PEOPLENUM_CHANGE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_PEOPLENUM_CHANGE");
        break;
    case ENUM_VCA_EVENT_SPACING_CHANGE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_SPACING_CHANGE");
        break;
    case ENUM_VCA_EVENT_COMBINED_RULE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_COMBINED_RULE");
        break;
    case ENUM_VCA_EVENT_SIT_QUIETLY:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_SIT_QUIETLY");
        break;
    case ENUM_VCA_EVENT_HIGH_DENSITY_STATUS:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_HIGH_DENSITY_STATUS");
        break;
    case ENUM_VCA_EVENT_RUNNING:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_RUNNING");
        break;
    case ENUM_VCA_EVENT_RETENTION:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_RETENTION");
        break;
    case ENUM_VCA_EVENT_BLACKBOARD_WRITE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_BLACKBOARD_WRITE");
        break;
    case ENUM_VCA_EVENT_SITUATION_ANALYSIS:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_SITUATION_ANALYSIS");
        break;
    case ENUM_VCA_EVENT_PLAY_CELLPHONE:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_PLAY_CELLPHONE");
        break;
    case ENUM_VCA_EVENT_DURATION:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_DURATION");
        break;
    case ENUM_VCA_EVENT_FAKECARD:
        sprintf(csEventType, "%s", "ENUM_VCA_EVENT_FAKECARD");
        break;
    default:
        sprintf(csEventType, "%s", "other");
        break;
    }
    sprintf(szInfoBuf, "Smart:[%d] DevIP:[%s]DevIPV6[%s]TargetID[%d]RuleID[%d]RuleName[%s]AbsTime[%u]piclen[%d]PicType[%d]RelAlarmPicNum[%d]AlarmID[%d]IvmsChannel[%d]IvmsChannelEx[%d]EventTypeEx[%s]byPicTransType[%d]RECT[X:%.3f][Y:%.3f][H:%.3f][W:%.3f]bySceneID[%d]",
        struVcaRuleAlarm.bySmart,
        struVcaRuleAlarm.struDevInfo.struDevIP.sIpV4, struVcaRuleAlarm.struDevInfo.struDevIP.byIPv6,struVcaRuleAlarm.struTargetInfo.dwID,
        ...
        csEventType, struVcaRuleAlarm.byPicTransType, struVcaRuleAlarm.struTargetInfo.struRect.fX, struVcaRuleAlarm.struTargetInfo.struRect.fY,
	...
	sprintf(szInfoBuf, "NET_VCA_TARGET_INFO:ID[%d]RECT[%.3f][%.3f][%.3f][%.3f]\n",
	...
	case ENUM_VCA_EVENT_TRAVERSE_PLANE://
		{
			sprintf(szInfoBuf,"ENUM_VCA_EVENT_TRAVERSE_PLANE:struRul:start[%.3f][%.3f]end[%.3f][%.3f]\ndwCrossDirection:[%d]bySensitivity[%d]byDetectionTarget[%d]\n"
                ...
                struVcaRuleAlarm.struRuleInfo.uEventParam.struTraversePlane.byDetectionTarget);
				OutputDebugString(szInfoBuf);
	...
	case ENUM_VCA_EVENT_ENTER_AREA:
		{
			...
			{
                sprintf(szInfoBuf, "%s Point[%d] fX[%.3f] fY[%.3f]", szInfoBuf, i, tempPolygon.struPos[i].fX, tempPolygon.struPos[i].fY);
				OutputDebugString(szInfoBuf);
			}
            g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
		}
    ...
    case ENUM_VCA_EVENT_LEAVE_POSITION:
    {
        ...
        sprintf(szInfoBuf, "%s wLeaveDelay[%d] wStaticDelay[%d] byMode[%d] byPersonType[%d] byOnPosition[%d] ", szInfoBuf, struVcaRuleAlarm.struRuleInfo.uEventParam.struLeavePos.wLeaveDelay, struVcaRuleAlarm.struRuleInfo.uEventParam.struLeavePos.wStaticDelay, struVcaRuleAlarm.struRuleInfo.uEventParam.struLeavePos.byMode, struVcaRuleAlarm.struRuleInfo.uEventParam.struLeavePos.byPersonType, struVcaRuleAlarm.struRuleInfo.uEventParam.struLeavePos.byOnPosition);
        OutputDebugString(szInfoBuf);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    }
    break;
    case ENUM_VCA_EVENT_FALL_DOWN:
    {
        ...
        sprintf(szInfoBuf, "%s wDuration[%d] bySensitivity[%d] byHeightThreshold[%d]", szInfoBuf, struVcaRuleAlarm.struRuleInfo.uEventParam.struFallDown.wDuration, struVcaRuleAlarm.struRuleInfo.uEventParam.struFallDown.bySensitivity, struVcaRuleAlarm.struRuleInfo.uEventParam.struFallDown.byHeightThreshold);
        OutputDebugString(szInfoBuf);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    }
    break;
	...
	case VCA_LECTURE:
		{
			...
			for (i = 0; i < (int)tempPolygon.dwPointNum ;i ++)
			{
				...
				{
					sprintf(szInfoBuf,"Lecture  Event Start[%.3f][%.3f]",tempPolygon.struPos[i].fX,tempPolygon.struPos[i].fY);	
				}
				else if (struVcaRuleAlarm.struRuleInfo.uEventParam.struLecture.byAlarmState == 2)
				{
					sprintf(szInfoBuf,"Lecture  Event End[%.3f][%.3f]",tempPolygon.struPos[i].fX,tempPolygon.struPos[i].fY);
				}
	...
	case VCA_ANSWER:
		{
			...
			for (i = 0; i < (int)tempPolygon.dwPointNum ;i ++)
			{
				...
				{
					sprintf(szInfoBuf,"Answering Questions Event [%.3f][%.3f]",tempPolygon.struPos[i].fX,tempPolygon.struPos[i].fY);
				}
	...
	case ENUM_VCA_EVENT_HIGH_DENSITY_STATUS:
		{
			...
			for (i = 0; i < (int)tempPolygon.dwPointNum ;i ++)
			{
				sprintf(szInfoBuf,"[%.3f][%.3f]",tempPolygon.struPos[i].fX,tempPolygon.struPos[i].fY);
				OutputDebugString(szInfoBuf);
			}
            g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
		}
    ...
    {
        NET_VCA_POLYGON tempPolygon;
        memcpy(&tempPolygon, &struVcaRuleAlarm.struRuleInfo.uEventParam.struPeopleNumChange.struRegion, sizeof(NET_VCA_POLYGON));

        sprintf(szInfoBuf, "People number change");

        for (i = 0; i < (int)tempPolygon.dwPointNum; i++)
        {
            sprintf(szInfoBuf, "%s Point[%d] [%.3f][%.3f]", szInfoBuf, i, tempPolygon.struPos[i].fX, tempPolygon.struPos[i].fY);
        }
    ...
    {
        NET_VCA_POLYGON tempPolygon;
        memcpy(&tempPolygon, &struVcaRuleAlarm.struRuleInfo.uEventParam.struSpacingChange, sizeof(NET_VCA_POLYGON));

        sprintf(szInfoBuf, "Spacing change:");
        ...
        sprintf(szInfoBuf, "%s SpacingThreshold[%.3f] Sensitivity[%d] DetectMode[%d] Duration[%d]",
            szInfoBuf, struVcaRuleAlarm.struRuleInfo.uEventParam.struSpacingChange.fSpacingThreshold, \
            struVcaRuleAlarm.struRuleInfo.uEventParam.struSpacingChange.bySensitivity, struVcaRuleAlarm.struRuleInfo.uEventParam.struSpacingChange.byDetectMode, \
            struVcaRuleAlarm.struRuleInfo.uEventParam.struSpacingChange.wDuration);
    ...
    {
        NET_VCA_POLYGON tempPolygon;
        memcpy(&tempPolygon, &struVcaRuleAlarm.struRuleInfo.uEventParam.struFakeCard.struRegion, sizeof(NET_VCA_POLYGON));

        sprintf(szInfoBuf, "Fake card");
        ...
        sprintf(szInfoBuf, "%s bySensitivity[%d]", szInfoBuf, struVcaRuleAlarm.struRuleInfo.uEventParam.struFakeCard.bySensitivity);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    }
    break;
	default:
	...
	if (struVcaRuleAlarm.dwPicDataLen > 0 && struVcaRuleAlarm.pImage != NULL)
	{
        ...
        sprintf(cFilename, "%s\\%s[%d][%d][%d]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, tmpDevInfo.byChannel, num);
		if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
		{
			CreateDirectory(cFilename, NULL);
		}
        ...
        {
            sprintf(cFilename, "%s\\LocalTime[%s]EventType[%d]TargetID[%d]RuleName[%s]AlarmID[%d]_%d.txt", cFilename, chTime, \
                struVcaRuleAlarm.struRuleInfo.wEventTypeEx,struVcaRuleAlarm.struTargetInfo.dwID, csRuleName, struVcaRuleAlarm.dwAlarmID, rand() % GetTickCount());
        }
        else
        {
            sprintf(cFilename, "%s\\LocalTime[%s]EventType[%d]TargetID[%d]RuleName[%s]AlarmID[%d]_%d.jpg", cFilename, chTime, \
                struVcaRuleAlarm.struRuleInfo.wEventTypeEx,struVcaRuleAlarm.struTargetInfo.dwID, csRuleName, struVcaRuleAlarm.dwAlarmID, rand() % GetTickCount());
        }
    ...
    if (struVcaRuleAlarm.byAppendInfoUploadEnabled==1)
    {
        ...
        sprintf(szInfoBuf, "append info:append pic type[%d];append pic len[%d];AppendChannelType[%d] AppendChannel[%d] append UID[%s] byApplicationScene[%d];append targetSpeed:[%d];append targetDistance:[%d];append alarmType:[%d];append radarChannel:[%d]",
            struAppendInfo.byAppendPicType, struAppendInfo.dwAppendPicLen, struAppendInfo.byAppendChannelType, struAppendInfo.dwAppendChannel, struAppendInfo.byUID, struAppendInfo.byApplicationScene, struAppendInfo.dwTargetSpeed, struAppendInfo.dwTargetDistance, struAppendInfo.byAlarmType, struAppendInfo.byRadarChannel);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
        ...
        if (struAppendInfo.dwAppendPicLen>0 && struAppendInfo.pAppendPicBuff!=NULL)
        {
            ...
            sprintf(cFilename, "%s\\%s[%d][%d][%d]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, tmpDevInfo.byChannel, appendnum);
            if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
            {
                CreateDirectory(cFilename, NULL);
            }

            sprintf(cFilename, "%s\\LocalTime[%s]EventType[%d]_appendPic.jpg", cFilename, chTime, struVcaRuleAlarm.struRuleInfo.wEventTypeEx);
        ...
        if (struAppendInfo.pAppendPicBuff != NULL)
        {
            ...
            struAppendInfo.pAppendPicBuff = NULL;
        }
    }
...
void CClientDemoDlg::ProcAidAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    if (struAidAlarm.dwPicDataLen > 0 && struAidAlarm.pImage != NULL)
	{
        ...
        {
            sprintf(cFilename, "%s\\UnloginIP_channel[%d]_AID", g_struLocalParam.chPictureSavePath, struAidAlarm.struDevInfo.byChannel);
        }
...
void CClientDemoDlg::ProcAidAlarmV41(WPARAM wParam,LPARAM lParam)
{
    ...
    char szAIDType[128] = { 0 };
    if ((struAidAlarm.struAIDInfo.dwAIDType&CONGESTION) != 0)
    {
        g_StringLanType(szAIDType, "拥堵", "CONGESTION");
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&PARKING) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "停车", "PARKING");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&INVERSE) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "逆行", "INVERSE");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&PEDESTRIAN) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "行人", "PEDESTRIAN");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&DEBRIS) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "遗留物 抛洒物碎片", "DEBRIS");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&SMOKE) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "烟雾", "SMOKE");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&OVERLINE) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "压线", "OVERLINE");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&VEHICLE_CONTROL_LIST) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "禁止名单数据", "VEHICLE_CONTROL_LIST");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&SPEED) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "超速", "SPEED");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&LANECHANGE) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "变道", "LANECHANGE");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&TURNAROUND) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "掉头", "TURNAROUND");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&VEHICLE_OCCUPANCY_NONVEHICLE) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "机动车占用非机动车位", "VEHICLE_OCCUPANCY_NONVEHICLE");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&GASSER) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "加塞", "GASSER");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&ROADBLOCK) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "路障", "ROADBLOCK");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    ...
    if ((struAidAlarm.struAIDInfo.dwAIDType&TRAFFIC_ACCIDENT) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "交通事故检测", "TRAFFIC_ACCIDENT");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&PARALLEL_PARKING) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "侧方位停车检测", "PARALLEL_PARKING");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&FOG_DETECTION) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "浓雾检测", "FOG_DETECTION");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&OCCUPY_EMERGENCY_LANE) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "占用紧急车道", "OCCUPY_EMERGENCY_LANE");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&CONFLAGRATION) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "火灾", "CONFLAGRATION");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    ...
    if ((struAidAlarm.struAIDInfo.dwAIDType&LOADING_DOCK_TRIGGER_UPLOAD) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "月台触发上传", "LOADING_DOCK_TRIGGER_UPLOAD");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&OCCUPY_OVERTAKING_LANE) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "占用超车道", "OCCUPY_OVERTAKING_LANE");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&PROHIBITION_MARK_VIOLATION) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "违反禁令标志", "PROHIBITION_MARK_VIOLATION");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&CHECK_POINT) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "卡口", "CHECK_POINT");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    if ((struAidAlarm.struAIDInfo.dwAIDType&SUDDEN_SPEED_DROP) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "速度骤降", "SUDDEN_SPEED_DROP");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }

    if ((struAidAlarm.struAIDInfo.dwAIDType&SLOW_MOVING) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "车辆缓行", "SLOW_MOVING");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }

    if ((struAidAlarm.struAIDInfo.dwAIDType&CHANGE_LANE_CONTINUOUSLY) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "连续变道", "CHANGE_LANE_CONTINUOUSLY");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }

    if ((struAidAlarm.struAIDInfo.dwAIDType&S_SHARP_DRIVING) != 0)
    {
        char szAIDTypeTmp[32] = { 0 };
        g_StringLanType(szAIDTypeTmp, "蛇形行驶", "S_SHARP_DRIVING");
        sprintf(szAIDType, "%s%s", szAIDType, szAIDTypeTmp);
    }
    ...
    char byDeviceID[DEVICE_ID_LEN * 2] = { 0 };
    FormatPrintPercent((char*)struAidAlarm.byDeviceID, sizeof(struAidAlarm.byDeviceID), byDeviceID, sizeof(byDeviceID));
    ...
    sprintf(szInfoBuf, "Aid AlarmV41 xmlLen[%d]IvmsChan[%d]ID[%d]Name[%s]Type[%d]VisibilityLevel[%d]newType[%s] TargetType[%d] LaneNo[%d] Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d]Dev IP[%s]Port[%d]Chan[%d] \
        Direction Start[%0.3f,%0.3f]Stop[%0.3f,%0.3f] SceneID[%d] SceneName[%s] Direction[%d] PTZ[%d,%d,%d] MonitoringSiteID[%s] DeviceID[%s] VehicleEnterState[%d] State[%d] ParkingID[%s] dwAIDTypeEx[%d] RuleID[%d] DevInfoIvmsChannelEx[%d]", 
        ...
        tempMonitoringSiteID, byDeviceID, struAidAlarm.struAIDInfo.byVehicleEnterState,
        struAidAlarm.struAIDInfo.byState, struAidAlarm.struAIDInfo.byParkingID, struAidAlarm.struAIDInfo.dwAIDTypeEx, struAidAlarm.byRuleID, struAidAlarm.wDevInfoIvmsChannelEx);
...
void CClientDemoDlg::ProcTpsStatistics(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "TPS Alarm Start[%d]CMD[%d]DeviceID[%d]TotalLaneNum[%d]DataLen[%d]StartTime[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d]SamplePeriod[%d]Chan[%d]DeiceIDEx[%d]", \
        ...
        struTpsStatistics.struTPSStatisticsInfo.dwDeviceIDEx);
    g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    ...
    if (1 == struTpsStatistics.byJsonInfoFlag)
    {
        SYSTEMTIME t;
        GetLocalTime(&t);
        char chTime[128];
        ...
        DWORD dwWrittenBytes = 0;
        DWORD dwRet = WriteFile(hFile, struTpsStatistics.pJsonBuf, struTpsStatistics.dwJsonLen, &dwWrittenBytes, NULL);
        if (dwRet == 0 || dwWrittenBytes < struTpsStatistics.dwJsonLen)
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "Subscribe failed event info Write to File Fail.System Error:%d, dwDataLen:%d, WrittenBytes:%d ", dwError, struTpsStatistics.dwJsonLen, dwWrittenBytes);
        }

        g_StringLanType(szLan, "Json数据返回", "Json data returned");
...
void CClientDemoDlg::ProcTpsRealtime(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "TPS Real Time Alarm Channel[%d]Time[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d]Start[%d]CMD[%d]SpaceHeadway[%d]TimeHeadway[%d]DeviceID[%d]DataLen[%d]Lane[%d] \
                      Speed[%d]LaneState[%d]QueueLen[%d]LoopState[%d]StateMask[%d]DownwardFlow[%d]UpwardFlow[%d]JamLevel[%d]VehicleDirection[%d]JamFlow[%d]ChannelizationLane[%d]VehicleType[%d]dwDeviceIDEx[%d]", \
        ...
        struTpsRealtime.struTPSRealTimeInfo.byChannelizationLane, struTpsRealtime.struTPSRealTimeInfo.byVehicleType, \
        struTpsRealtime.dwDeviceIDEx );
    g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    ...
    if (1 == struTpsRealtime.byAddInfoFlag)
    {
        ...
        sprintf(szInfoBuf, "AddInfoFlag [%d] First Car:LatitudeType [%d] Degree[%d] Minute[%d] fSec[%.3f] LongitudeType [%d] Degree[%d] Minute[%d] fSec[%.3f], \
                   Last Car:LatitudeType [%d] Degree[%d] Minute[%d] fSec[%.3f] LongitudeType [%d] Degree[%d] Minute[%d] fSec[%.3f] sLicense[%s] struTurnDirection:byLine[%d] \
                   byStatus[%d] struStopLine:byStatus[%d]", \
           ...
           struTPSAddInfo.sLicense, struTPSAddInfo.struTurnDirection.byLine, struTPSAddInfo.struTurnDirection.byStatus, \
           struTPSAddInfo.struStopLine.byStatus);
        g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    }
...
void CClientDemoDlg::ProcTfsAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    CString szTmp = "";
    szTmp.Format("%s", tempMonitoringSiteID);
    string szMonitoringSiteID = UTF82ASCII(szTmp);
    char byDeviceID[64] = { 0 };
    char byDeviceIDADD[49] = { 0 };
    memcpy(byDeviceIDADD, struTfsAlarm.byDeviceID, sizeof(struTfsAlarm.byDeviceID));
    FormatPrintPercent((char*)struTfsAlarm.byDeviceID, sizeof(struTfsAlarm.byDeviceID), byDeviceID, sizeof(byDeviceID));
    //demo显示第一次打印,已经显示到最多了，新增的需要在第二次打印增加
    sprintf(szInfoBuf, "Tfs Alarm IvmsChan: [%d] RuleID: [%d] RuleName: [%s] AIDType: [%d] dwAIDTypeEx[%d] AbsTime: [%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] DevIPv4: [%s] DevIPv6: [%s] Port: [%d] Chan: [%d] SpecificVehicleType: [%d]\
                           ...
                           DeviceID: [%s] PlateType: [%d] Color: [%d] Bright: [%d] LicenseLen: [%d] EntireBelieve: [%d] Region: [%d] Country: [%d] Area: [%d] PlateSize: [%d] AddInfoFlag: [%d] CRIndex: [%d] sPlateCategory[%s] \
                           XmlLen: [%d] PlateRect:[%f,%f,%f,%f] Licence: [%s] Believe: [%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u,%u] Time: [%s] SerialNo: [%d] VehicleAttribute: [%d] PilotSafebelt: [%d] \
                           CopilotSafebelt: [%d]PilotSunVisor: [%d] CopilotSunVisor: [%d] PilotCall: [%d] IllegalCode: [%s] VehicleEnterState: [%d] wCountry: [%d] Region: [%d] State:[%d] ParkingID:[%s] CrossLine:[%d] ParkingSerialNO:[%s]\
                           CrossSpaces:[%d] AngledParking:[%d] AlarmValidity:[%d] DoorStatus:[%d] byVehicleHeadTailStatus:[%d] BeginRecTime:[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] EndRecTime:[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d]",\
            struTfsAlarm.struDevInfo.byIvmsChannel, struTfsAlarm.struAIDInfo.byRuleID, struTfsAlarm.struAIDInfo.byRuleName,
            struTfsAlarm.struAIDInfo.dwAIDType, struTfsAlarm.struAIDInfo.dwAIDTypeEx, struAbsTime.dwYear, struAbsTime.dwMonth, struAbsTime.dwDay,
            struAbsTime.dwHour, struAbsTime.dwMinute, struAbsTime.dwSecond, struTfsAlarm.struDevInfo.struDevIP.sIpV4, struTfsAlarm.struDevInfo.struDevIP.byIPv6,
            ...
            struTfsAlarm.dwIllegalType, struTfsAlarm.dwIllegalDuration, szMonitoringSiteID.c_str(), /*struTfsAlarm.*/byDeviceID,
            struTfsAlarm.struPlateInfo.byPlateType, struTfsAlarm.struPlateInfo.byColor, struTfsAlarm.struPlateInfo.byBright, struTfsAlarm.struPlateInfo.byLicenseLen, struTfsAlarm.struPlateInfo.byEntireBelieve, 
            struTfsAlarm.struPlateInfo.byRegion, struTfsAlarm.struPlateInfo.byCountry, struTfsAlarm.struPlateInfo.byArea, struTfsAlarm.struPlateInfo.byPlateSize, struTfsAlarm.struPlateInfo.byAddInfoFlag,
            struTfsAlarm.struPlateInfo.wCRIndex, struTfsAlarm.struPlateInfo.sPlateCategory, struTfsAlarm.struPlateInfo.dwXmlLen,
            struTfsAlarm.struPlateInfo.struPlateRect.fX, struTfsAlarm.struPlateInfo.struPlateRect.fY, struTfsAlarm.struPlateInfo.struPlateRect.fWidth, struTfsAlarm.struPlateInfo.struPlateRect.fHeight,
            struTfsAlarm.struPlateInfo.sLicense, struTfsAlarm.struPlateInfo.byBelieve[0], struTfsAlarm.struPlateInfo.byBelieve[1], struTfsAlarm.struPlateInfo.byBelieve[2], 
            struTfsAlarm.struPlateInfo.byBelieve[3], struTfsAlarm.struPlateInfo.byBelieve[4], struTfsAlarm.struPlateInfo.byBelieve[5], struTfsAlarm.struPlateInfo.byBelieve[6], struTfsAlarm.struPlateInfo.byBelieve[7],
            ...
            struTfsAlarm.struEndRecTime.byHour, struTfsAlarm.struEndRecTime.byMinute, struTfsAlarm.struEndRecTime.bySecond);
    g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    memset(szInfoBuf, 0, sizeof(szInfoBuf));
    //第二次打印
    sprintf(szInfoBuf, "Tfs Alarm VehicleIndex:[%d] VehicleType:[%d] ColorDepth:[%d] VehicleColor:[%d] VehicleLogoRecog:[%d] VehicleSubLogoRecog:[%d] VehicleModel:[%d] PicNum:[%d] byIllegalType[%d] byBelieve[%d] DevInfoIvmsChannelEx[%d]",
		...
		struTfsAlarm.struVehicleInfo.byVehicleModel, struTfsAlarm.dwPicNum, struTfsAlarm.struVehicleInfo.byIllegalType, struTfsAlarm.struVehicleInfo.byBelieve, struTfsAlarm.wDevInfoIvmsChannelEx);
    g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    memset(szInfoBuf, 0, sizeof(szInfoBuf));
    ...
    sprintf(szInfoBuf, "Tfs Alarm IvmsChan: [%d]\r\nRuleID: [%d]\r\nRuleName: [%s]\r\nAIDType: [%d]\r\nAbsTime: [%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d]\r\nDevIPv4: [%s]\r\nDevIPv6: [%s]\r\nPort: [%d]\r\nChan: [%d]\r\nSpecificVehicleType: [%d]\
            ...
            struTfsAlarm.struSceneInfo.dwSceneID, struTfsAlarm.struSceneInfo.bySceneName, struTfsAlarm.struSceneInfo.byDirection,
            struTfsAlarm.struSceneInfo.struPtzPos.wPanPos, struTfsAlarm.struSceneInfo.struPtzPos.wTiltPos, struTfsAlarm.struSceneInfo.struPtzPos.wZoomPos,
            struTfsAlarm.dwIllegalType, struTfsAlarm.dwIllegalDuration, szMonitoringSiteID.c_str(), /*struTfsAlarm.*/byDeviceIDADD,
            struTfsAlarm.struPlateInfo.byPlateType, struTfsAlarm.struPlateInfo.byColor, struTfsAlarm.struPlateInfo.byBright, struTfsAlarm.struPlateInfo.byLicenseLen, struTfsAlarm.struPlateInfo.byEntireBelieve,
            struTfsAlarm.struPlateInfo.byRegion, struTfsAlarm.struPlateInfo.byCountry, struTfsAlarm.struPlateInfo.byArea, struTfsAlarm.struPlateInfo.byPlateSize, struTfsAlarm.struPlateInfo.byAddInfoFlag,
            struTfsAlarm.struPlateInfo.wCRIndex, struTfsAlarm.struPlateInfo.sPlateCategory, struTfsAlarm.struPlateInfo.dwXmlLen,
            struTfsAlarm.struPlateInfo.struPlateRect.fX, struTfsAlarm.struPlateInfo.struPlateRect.fY, struTfsAlarm.struPlateInfo.struPlateRect.fWidth, struTfsAlarm.struPlateInfo.struPlateRect.fHeight,
            ...
            struTfsAlarm.struBeginRecTime.byHour, struTfsAlarm.struBeginRecTime.byMinute, struTfsAlarm.struBeginRecTime.bySecond, struTfsAlarm.struEndRecTime.wYear, struTfsAlarm.struEndRecTime.byMonth, struTfsAlarm.struEndRecTime.byDay,
            struTfsAlarm.struEndRecTime.byHour, struTfsAlarm.struEndRecTime.byMinute, struTfsAlarm.struEndRecTime.bySecond, struTfsAlarm.struVehicleInfo.dwIndex,
            struTfsAlarm.struVehicleInfo.byVehicleType, struTfsAlarm.struVehicleInfo.byColorDepth, struTfsAlarm.struVehicleInfo.byColor, struTfsAlarm.struVehicleInfo.wVehicleLogoRecog, struTfsAlarm.struVehicleInfo.byVehicleSubLogoRecog,
            struTfsAlarm.struVehicleInfo.byVehicleModel, struTfsAlarm.dwPicNum, struTfsAlarm.struVehicleInfo.byIllegalType, struTfsAlarm.struVehicleInfo.byBelieve, struTfsAlarm.wDevInfoIvmsChannelEx);
    ...
    {
        sprintf(dataFilename, "%s\\UnloginIP_channel[%d]_TFS", g_struLocalParam.chPictureSavePath, struTfsAlarm.struDevInfo.byChannel);
    ...
    for (int i = 0; i < 8; i++)
    {
        if (struTfsAlarm.struPicInfo[i].dwDataLen > 0 && struTfsAlarm.struPicInfo[i].pBuffer != NULL)
        {
            ...
            if (struTfsAlarm.struPicInfo[i].byDataType == 0)
            {
                ...
                else if (2 == struTfsAlarm.struPicInfo[i].byType)
                {
                    sprintf(cPicType, "Composite");
                }
                else if (3 == struTfsAlarm.struPicInfo[i].byType)
                {
                    sprintf(cPicType, "Stream"); 
                }
                else if (12 == struTfsAlarm.struPicInfo[i].byType)
                {
                    sprintf(cPicType, "Pilot room"); 
                }
                else if (14 == struTfsAlarm.struPicInfo[i].byType)
                {
                    sprintf(cPicType, "Face");
                }
    ...
    if (struTfsAlarm.dwXmlLen > 0 && struTfsAlarm.pXmlBuf != NULL)
    {
        int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
        ...
        if (iDeviceIndex != -1 || iDeviceIndex < MAX_DEVICES)
        {
            sprintf(cFilename, "%s\\%s_channel[%d]_TFS", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, struTfsAlarm.struDevInfo.byChannel);
        }
        else
        {
            sprintf(cFilename, "%s\\UnloginIP_channel[%d]_TFS", g_struLocalParam.chPictureSavePath, struTfsAlarm.struDevInfo.byChannel);
        }
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
            CreateDirectory(cFilename, NULL);
        ...
        sprintf(cFilename, "%s\\TFSXml_[%s].txt", cFilename, chTime);
        ...
        WriteFile(hFile, struTfsAlarm.pXmlBuf, struTfsAlarm.dwXmlLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }
}
...
void CClientDemoDlg::ProcFaceSnapAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "Face Snap alarm FaceSnapThermometryEnabled[%d] IsAbnomalTemperature[%d] ThermometryUnit[%d] FaceTemperature[%.1f] fAlarmTemperature[%.1f]BrokenNetHttp[%d]Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d flag[%d] %2.2d%2.2d] \
                        Relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] FaceID[%d] Smart[%d] byGroup[%d] Sex[%d] EyeGlass[%d] \
                       ...
                       byRes4[%d], Deviation[%d] FacePicQuality[%d] UIDLen[%d] Mask[%d] Smile[%d] \
                       ...
                       FaceExpression[%d] byRes1[%d] Hat[%d] \n",
                       struFaceSnapAddInfo.byFaceSnapThermometryEnabled, struFaceSnapAddInfo.byIsAbnomalTemperature, struFaceSnapAddInfo.byThermometryUnit, struFaceSnapAddInfo.fFaceTemperature, struFaceSnapAddInfo.fAlarmTemperature, \
                       ...
                       struRelativeTime.dwYear, struRelativeTime.dwMonth, struRelativeTime.dwDay, struRelativeTime.dwHour, struRelativeTime.dwMinute, struRelativeTime.dwSecond, \
                       struFaceSnapAlarm.dwFacePicID, struFaceSnapAlarm.bySmart, struFaceSnapAlarm.struFeature.byGroup, struFaceSnapAlarm.struFeature.bySex, \
                       ...
                       struFaceSnapAlarm.struDevInfo.byIvmsChannel, struFaceSnapAlarm.wDevInfoIvmsChannelEx, struFaceSnapAlarm.struFeature.byRes3, struFaceSnapAlarm.struFeature.byDeviation, struFaceSnapAlarm.byFacePicQuality, struFaceSnapAlarm.byUIDLen, \
                       struFaceSnapAlarm.struFeature.byMask, struFaceSnapAlarm.struFeature.bySmile,
                       ...
                       struFaceSnapAlarm.struFeature.byRes1, struFaceSnapAlarm.struFeature.byHat);

    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);

    // 修改打印显示不全的缺陷
    sprintf(szInfoBuf, "Face Snap alarm Channel[%d] IvmsChannel[%d] IPV4[%s] IPV6[%s] Port[%d] CustomChanID[%s] \
                       EnterTime[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] ExitTime[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] \
                       byLatitudeType[%d] byLongitudeType[%d] struLatitude[%d %d %.f] struLongitude[%d %d %.f] \
                       dwEventNotificationAlertLen[%d]",
                       struFaceSnapAlarm.struDevInfo.byChannel, struFaceSnapAlarm.struDevInfo.byIvmsChannel, struFaceSnapAlarm.struDevInfo.struDevIP.sIpV4, struFaceSnapAlarm.struDevInfo.struDevIP.byIPv6, struFaceSnapAlarm.struDevInfo.wPort, struFaceSnapAddInfo.szCustomChanID,\
                       ...
                       struFaceSnapAddInfo.struLLPos.byLatitudeType, struFaceSnapAddInfo.struLLPos.byLongitudeType, \
                       struFaceSnapAddInfo.struLLPos.struLatitude.byDegree, struFaceSnapAddInfo.struLLPos.struLatitude.byMinute, struFaceSnapAddInfo.struLLPos.struLatitude.fSec, \
                       struFaceSnapAddInfo.struLLPos.struLongitude.byDegree, struFaceSnapAddInfo.struLLPos.struLongitude.byMinute, struFaceSnapAddInfo.struLLPos.struLongitude.fSec, \
                       struFaceSnapAddInfo.dwEventNotificationAlertLen);
    ...
    int iPort = pAlarmDev->wLinkPort;
    int iChannel = 0;
    if (struFaceSnapAlarm.struDevInfo.byIvmsChannel > 0)
    {
        iChannel = struFaceSnapAlarm.struDevInfo.byIvmsChannel;
    }
    else
    {
        iChannel = struFaceSnapAlarm.struDevInfo.byChannel;
    }
    ...
    if (struFaceSnapAlarm.byUIDLen > 0 && struFaceSnapAlarm.pUIDBuffer != NULL)
    {
        ...
        sprintf(cFilename, "%s\\%s[%d][%d][%d]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort,iChannel, num);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
            CreateDirectory(cFilename, NULL);
        }
    ...
    if (struFaceSnapAddInfo.dwThermalPicLen > 0 && struFaceSnapAddInfo.pThermalPicBuff != NULL)
    {
        int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
        ...
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
            ...
            sprintf(cFilename, "%s\\ThermalPic[%s].jpg", cFilename, chTime);
        ...
        WriteFile(hFile, struFaceSnapAddInfo.pThermalPicBuff, struFaceSnapAddInfo.dwThermalPicLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }

    if (struFaceSnapAddInfo.dwEventNotificationAlertLen > 0 && struFaceSnapAddInfo.pEventNotificationAlertBuff != NULL)
    {
        int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
        ...
        sprintf(cFilename, "%s\\EventNotificationAlert[%s].json", cFilename, chTime);
        ...
        WriteFile(hFile, struFaceSnapAddInfo.pEventNotificationAlertBuff, struFaceSnapAddInfo.dwEventNotificationAlertLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }
}
...
// 			struFaceDetectionAlarm.struFacePic[i].fY != 0)
		{
			sprintf(szPicFace, "[Detection Face Snap alarm]facePic:%d fHeight:%.3f,fWidth:%.3f,fX:%.3f,fY:%.3f \n", i+1, \
...
void CClientDemoDlg::ProcFaceSnapMatchAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    char tempFDID[256] = {0};
    if (struFaceSnapMatchAlarm.struBlockListInfo.dwFDIDLen > 0 
        && struFaceSnapMatchAlarm.struBlockListInfo.dwFDIDLen < sizeof(tempFDID)
        && struFaceSnapMatchAlarm.struBlockListInfo.pFDID != NULL)
    {
        memcpy(tempFDID, struFaceSnapMatchAlarm.struBlockListInfo.pFDID, struFaceSnapMatchAlarm.struBlockListInfo.dwFDIDLen);
    }
    char temppID[256] = { 0 };
    if (struFaceSnapMatchAlarm.struBlockListInfo.dwPIDLen > 0 
        && struFaceSnapMatchAlarm.struBlockListInfo.dwPIDLen < sizeof(temppID)
        && struFaceSnapMatchAlarm.struBlockListInfo.pPID != NULL)
    {
        memcpy(temppID, struFaceSnapMatchAlarm.struBlockListInfo.pPID, struFaceSnapMatchAlarm.struBlockListInfo.dwPIDLen);
    }
    char tempFDDesc[256] = { 0 };
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen > 0 
        && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen < sizeof(tempFDDesc)
        && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer != NULL)
    {
        memcpy(tempFDDesc, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen);
    }
    string strFDDesc = UTF82ASCII(tempFDDesc);

    char tempFCAddition[512] = { 0 };
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen > 0 
        && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen < sizeof(tempFCAddition)
        && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer != NULL)
    {
        memcpy(tempFCAddition, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen);
    }

    string strFCAddition = UTF82ASCII(tempFCAddition);

    sprintf(szInfoBuf, "Face Snap Match alarm Channel[%d] IvmsChannel[%d] BrokenNetHttp[%d] Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] diff[%2.2d%2.2d] FaceID[%d] BlockList ID[%d] StorageIP[%s]-StoragePort[%d] byFaceScore[%d] Sex[%d] Glasses[%d] byRes1[%d] FacePicQuality[%d]\
             StayDuration[%0.3f] MatchPicNum[%d] struRegion[%0.3f, %0.3f, %0.3f, %0.3f] PicTransType[%d]  FDID[%s]   PID[%s] FDDesc[\r\n%s\r\n] Similarity[%.3f]  ThresholdValue[%d]\
              ListType[%d] ContrastStatus[%d] ModelingStatus[%d] Mask[%d] Smile[%d] FCAddtion[\r\n%s\r\n] LivenessDetectionStatus[%d] IsNoSaveFDPicture[%d] byRealTimeContrast[%d]\n",
               ...
               struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwRegisterID, \
               struFaceSnapMatchAlarm.sStorageIP, struFaceSnapMatchAlarm.wStoragePort, struFaceSnapMatchAlarm.struSnapInfo.byFaceScore, \
               struFaceSnapMatchAlarm.struSnapInfo.bySex, struFaceSnapMatchAlarm.struSnapInfo.byGlasses, \
               struFaceSnapMatchAlarm.struSnapInfo.byRes1, struFaceSnapMatchAlarm.struSnapInfo.byFacePicQuality, struFaceSnapMatchAlarm.struSnapInfo.fStayDuration, struFaceSnapMatchAlarm.byMatchPicNum, \
               struFaceSnapMatchAlarm.struRegion.fX, struFaceSnapMatchAlarm.struRegion.fY, struFaceSnapMatchAlarm.struRegion.fWidth, struFaceSnapMatchAlarm.struRegion.fHeight, struFaceSnapMatchAlarm.byPicTransType, tempFDID, temppID, strFDDesc.c_str(), struFaceSnapMatchAlarm.fSimilarity, struFaceSnapMatchAlarm.struBlockListInfo.wThresholdValue, \
               struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.byType, struFaceSnapMatchAlarm.byContrastStatus, struFaceSnapMatchAlarm.byModelingStatus, struFaceSnapMatchAlarm.byMask, struFaceSnapMatchAlarm.bySmile, (char*)tempFCAddition, struFaceSnapMatchAlarm.byLivenessDetectionStatus, \
               struFaceSnapMatchAlarm.struBlockListInfo.byIsNoSaveFDPicture, struFaceSnapMatchAlarm.struBlockListInfo.byRealTimeContrast);
...
//         sprintf(chTime,"%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d",t.wYear,t.wMonth,t.wDay,t.wHour,t.wMinute,t.wSecond,t.wMilliseconds);
    ...
    if (struFaceSnapMatchAlarm.struBlockListInfo.dwBlockListPicLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.pBuffer1 != NULL)
    {
        int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
        ...
        if (struFaceSnapMatchAlarm.byPicTransType)
        {
            sprintf(cFilename, "%s\\Match_BlockList_Pic[%s].txt", cFilename, chTime);
        }
        else
        {
            sprintf(cFilename, "%s\\Match BlockList Pic[%s].jpg", cFilename, chTime);
        }
        hFile = CreateFile(cFilename, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        if (hFile == INVALID_HANDLE_VALUE)
        {
        ...
        WriteFile(hFile, struFaceSnapMatchAlarm.struBlockListInfo.pBuffer1, struFaceSnapMatchAlarm.struBlockListInfo.dwBlockListPicLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
	}
    ...
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend != NULL)
    {
        char cFilename[256] = { 0 };
        int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
        ...
        WriteFile(hFile, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }

    //保存热成像图片
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwThermalDataLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pThermalData != NULL)
    {
        char cFilename[256] = { 0 };
        int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
        ...
        WriteFile(hFile, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pThermalData, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwThermalDataLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }
	...
	if (struFaceSnapMatchAlarm.struBlockListInfo.pBuffer1 != NULL)
	{
		delete []struFaceSnapMatchAlarm.struBlockListInfo.pBuffer1;
		struFaceSnapMatchAlarm.struBlockListInfo.pBuffer1 = NULL;
	}
    ...
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend != NULL)
    {
        delete[]struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend;
        struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend = NULL;
    }
    ...
    if (struFaceSnapMatchAlarm.struBlockListInfo.pFDID != NULL)
    {
        delete[]struFaceSnapMatchAlarm.struBlockListInfo.pFDID;
        struFaceSnapMatchAlarm.struBlockListInfo.pFDID = NULL;
    }

    if (struFaceSnapMatchAlarm.struBlockListInfo.pPID != NULL)
    {
        delete[]struFaceSnapMatchAlarm.struBlockListInfo.pPID;
        struFaceSnapMatchAlarm.struBlockListInfo.pPID = NULL;
    }

    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer != NULL)
    {
        delete[]struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer;
        struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer = NULL;
    }

    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer != NULL)
    {
        delete[]struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer;
        struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer = NULL;
    }

    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pThermalData != NULL)
    {
        delete[]struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pThermalData;
        struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pThermalData = NULL;
    }
...
void CClientDemoDlg::FaceSnapMatchAlarmInfo(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(sInfo, "%s byRes1=%d \r\n", sInfo, struFaceSnapMatchAlarm.struSnapInfo.byRes1);
    sprintf(sInfo, "%s byDeviation=%d \r\n", sInfo, struFaceSnapMatchAlarm.struSnapInfo.byDeviation);
    sprintf(sInfo, "%s byGroup=%d \r\n", sInfo, struFaceSnapMatchAlarm.struSnapInfo.byGroup);
    ...
    sprintf(sInfo, "%sNET_VCA_BLOCKLIST_INFO_ALARM", sInfo);
    sprintf(sInfo, "%s dwBlockListPicLen=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.dwBlockListPicLen);
    sprintf(sInfo, "%s byIsNoSaveFDPicture=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.byIsNoSaveFDPicture);
    sprintf(sInfo, "%s byRealTimeContrast=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.byRealTimeContrast);

    // NET_VCA_BLOCKLIST_INFO
    sprintf(sInfo, "%sNET_VCA_BLOCKLIST_INFO", sInfo);

    sprintf(sInfo, "%s dwRelativeTime=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwRegisterID);
    sprintf(sInfo, "%s dwGroupNo=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwGroupNo);
    sprintf(sInfo, "%s byType=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.byType);
    sprintf(sInfo, "%s byLevel=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.byLevel);
    sprintf(sInfo, "%s byRemark=%s \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.byRemark);


    // NET_VCA_HUMAN_ATTRIBUTE
    sprintf(sInfo, "%sNET_VCA_HUMAN_ATTRIBUTE\r\n", sInfo);
    sprintf(sInfo, "%s bySex=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.bySex);
    sprintf(sInfo, "%s byCertificateType=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.byCertificateType);
    sprintf(sInfo, "%s byBirthDate=%s \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.byBirthDate);
    sprintf(sInfo, "%s byName=%s \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.byName);
    sprintf(sInfo, "%s byCertificateNumber=%s \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.byCertificateNumber);
    sprintf(sInfo, "%s byMaturityGroup=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.byGroup);



    // NET_DVR_AREAINFOCFG
    sprintf(sInfo, "%sNET_DVR_AREAINFOCFG \r\n", sInfo);
    sprintf(sInfo, "%s dwCode=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.struNativePlace.dwCode);
    sprintf(sInfo, "%s wNationalityID=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.struNativePlace.wNationalityID);
    sprintf(sInfo, "%s wProvinceID=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.struNativePlace.wProvinceID);
    sprintf(sInfo, "%s wCityID=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.struNativePlace.wCityID);
    sprintf(sInfo, "%s wCountyID=%d \r\n", sInfo, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.struNativePlace.wCountyID);
    ...
    char tempFDID[256] = { 0 };
    if (struFaceSnapMatchAlarm.struBlockListInfo.dwFDIDLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.pFDID != NULL)
    {
        memcpy(tempFDID, struFaceSnapMatchAlarm.struBlockListInfo.pFDID, struFaceSnapMatchAlarm.struBlockListInfo.dwFDIDLen);
    }
    char temppID[256] = { 0 };
    if (struFaceSnapMatchAlarm.struBlockListInfo.dwPIDLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.pPID != NULL)
    {
        memcpy(temppID, struFaceSnapMatchAlarm.struBlockListInfo.pPID, struFaceSnapMatchAlarm.struBlockListInfo.dwPIDLen);
    }

    char *tempFDDesc = new char[struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen + 1];
    if (tempFDDesc != NULL)
    {
        memset(tempFDDesc, 0, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen + 1);
        if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer != NULL)
        {
            memcpy(tempFDDesc, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFDDescriptionBuffer, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFDDescriptionLen);
        }
    }
    ...
    char *tempFCAddition = new char[struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen + 1];
    if (tempFCAddition != NULL)
    {
        memset(tempFCAddition, 0, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen + 1);
        if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen > 0
            && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer != NULL)
        {
            memcpy(tempFCAddition, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.pFCAdditionInfoBuffer, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwFCAdditionInfoLen);
    ...
    sprintf(szInfoBuf, "Face Snap Match alarm Channel[%d] IvmsChannel[%d] BrokenNetHttp[%d] Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] diff[%2.2d%2.2d] \
                       ...
                       FaceID[%d] BlockList ID[%d] StorageIP[%s]-StoragePort[%d] byFaceScore[%d] Sex[%d] Glasses[%d] byRes1[%d] FacePicQuality[%d]\
                       StayDuration[%0.3f] MatchPicNum[%d] struRegion[%0.3f, %0.3f, %0.3f, %0.3f] PicTransType[%d] Similarity[%.3f]  ThresholdValue[%d]\
                       ListType[%d] ContrastStatus[%d] ModelingStatus[%d] Mask[%d] Smile[%d] \
                       LivenessDetectionStatus[%d] IsNoSaveFDPicture[%d] byRealTimeContrast[%d]\n",
                       struFaceSnapMatchAlarm.struSnapInfo.struDevInfo.byChannel, struFaceSnapMatchAlarm.struSnapInfo.struDevInfo.byIvmsChannel, struFaceSnapMatchAlarm.byBrokenNetHttp, \
                       struAbsTime.dwYear, struAbsTime.dwMonth, struAbsTime.dwDay, struAbsTime.dwHour, struAbsTime.dwMinute, struAbsTime.dwSecond, \
                       struFaceSnapMatchAlarm.cTimeDifferenceH, struFaceSnapMatchAlarm.cTimeDifferenceM, \
                       struRelativeTime.dwYear, struRelativeTime.dwMonth, struRelativeTime.dwDay, struRelativeTime.dwHour, struRelativeTime.dwMinute, struRelativeTime.dwSecond,\
                       struFaceSnapMatchAlarm.struSnapInfo.dwSnapFacePicID, \
                       ...
                       struFaceSnapMatchAlarm.struSnapInfo.bySex, struFaceSnapMatchAlarm.struSnapInfo.byGlasses, \
                       struFaceSnapMatchAlarm.struSnapInfo.byRes1, struFaceSnapMatchAlarm.struSnapInfo.byFacePicQuality, struFaceSnapMatchAlarm.struSnapInfo.fStayDuration, struFaceSnapMatchAlarm.byMatchPicNum, \
                       struFaceSnapMatchAlarm.struRegion.fX, struFaceSnapMatchAlarm.struRegion.fY, struFaceSnapMatchAlarm.struRegion.fWidth, struFaceSnapMatchAlarm.struRegion.fHeight, struFaceSnapMatchAlarm.byPicTransType, struFaceSnapMatchAlarm.fSimilarity, struFaceSnapMatchAlarm.struBlockListInfo.wThresholdValue, \
                       struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.byType, struFaceSnapMatchAlarm.byContrastStatus, struFaceSnapMatchAlarm.byModelingStatus, struFaceSnapMatchAlarm.byMask, struFaceSnapMatchAlarm.bySmile, struFaceSnapMatchAlarm.byLivenessDetectionStatus, \
                       struFaceSnapMatchAlarm.struBlockListInfo.byIsNoSaveFDPicture, struFaceSnapMatchAlarm.struBlockListInfo.byRealTimeContrast);

    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);

    memset(szInfoBuf, 0, sizeof(szInfoBuf));
    sprintf(szInfoBuf, "Face Snap Match alarm FDID[%s] PID[%s] FDDesc[\r\n%s] FCAddtion[\r\n%s]",tempFDID, temppID, strFDDesc.c_str(),strFCAddition.c_str()); //数据太长显示不完整，重新列举一个
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    ...
    sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
    int iPort = pAlarmDev->wLinkPort;
    int ichannel = struFaceSnapMatchAlarm.struSnapInfo.struDevInfo.byChannel;
    ...
    if (struFaceSnapMatchAlarm.struSnapInfo.dwUIDLen > 0 && struFaceSnapMatchAlarm.struSnapInfo.pUIDBuffer != NULL)
    {
        ...
        sprintf(cFilename, "%s\\%s[%d][facematch]_channel_[%d]\\", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, ichannel);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
            int i = GetLastError();
            CreateDirectory(cFilename, NULL);
        }
        sprintf(cFilename, "%sAbs_%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d_", cFilename, struAbsTime.dwYear, struAbsTime.dwMonth, struAbsTime.dwDay, \
            struAbsTime.dwHour, struAbsTime.dwMinute, struAbsTime.dwSecond, t.wMilliseconds);
        for (int i = 0; i < 17; i++)
        {
            if (cUID[i] != '0')
            {
    ...
    if (struFaceSnapMatchAlarm.struBlockListInfo.dwBlockListPicLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.pBuffer1 != NULL)
    {
        ...
        if (struFaceSnapMatchAlarm.byPicTransType)
        {
            sprintf(cFilenameTemp, "%s\\Match_BlockList_Pic[%s].txt", cFilename, chTime);
        }
        else
        {
            sprintf(cFilenameTemp, "%s\\MatchBlockListPic[%d%d].jpg", cFilename, struFaceSnapMatchAlarm.struBlockListInfo.dwBlockListPicLen, g_iCount);
        }
        hFile = CreateFile(cFilenameTemp, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        if (hFile == INVALID_HANDLE_VALUE)
        {
    ...
    if (struFaceSnapMatchAlarm.dwModelDataLen > 0 && struFaceSnapMatchAlarm.pModelDataBuffer != NULL)
    {
        ...
        HANDLE hFile;
        DWORD dwReturn;
        sprintf(cFilenameTemp, "%s\\MatchBlockLisModelData[%s].txt", cFilename, chTime);
        hFile = CreateFile(cFilenameTemp, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        if (hFile == INVALID_HANDLE_VALUE)
        {
            return;
    ...
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pPersonInfoExtend != NULL)
    {
        HANDLE hFile;
        DWORD dwReturn;
        sprintf(cFilenameTemp, "%s\\MatchBlockListCustomInfoLen[%d%d].txt", cFilename, struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.dwPersonInfoExtendLen, g_iCount);
        hFile = CreateFile(cFilenameTemp, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        if (hFile == INVALID_HANDLE_VALUE)
        {
            return;
    ...
    if (struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.dwThermalDataLen > 0 && struFaceSnapMatchAlarm.struBlockListInfo.struBlockListInfo.struAttribute.pThermalData != NULL)
    {
        ...
        sprintf(cFilenameTemp, "%s\\ThermalPic[%s].jpg", cFilename, chTime);
...
void CClientDemoDlg::ProcRuleInfoUpload(WPARAM wParam, LPARAM lParam)
{
    ...
    for ( i = 0; i < struRuleInfo.struEventInfoList.byNum; i++)
    {
        ...
        {
            sprintf(szInfoBuf, "High density RuleID[%d]Name[%s]density[%.3f]", struEventInfo.byRuleID, struEventInfo.byRuleName, 
...
void CClientDemoDlg::ProcSensorAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szLan, "Sensor Alarm:AbsTime[%d]Name[%s]SensorChan[%d]Type[%d]AlramType[%d]AlarmMode[%u]Value[%.3f]",
...
void CClientDemoDlg::ProcSensorValueUpload(WPARAM wParam, LPARAM lParam)
{
    ...
    char szLan[1024] = {0};
    sprintf(szLan, "ValueUpload:AbsTime[%d]Name[%s]SensorChan[%d]Type[%d]Value[%.3f]",
...
void CClientDemoDlg::ProcAlarmHostCIDAlarm(WPARAM wParam, LPARAM lParam)
{
	...
	else
	{
		...
		case CID_ENTER+CID_SOFT_MOBS:
			...
			sprintf(sTempEn, "Soft Zone suspect Alarm");
			break;
...
void CClientDemoDlg::ProcessAlarmhostPointValue(char* szLanCn, char* szLanEn, LPNET_DVR_ALARMHOST_POINT_VALUE lpAlarm)
{
	...
	case 2:
		...
		break;
	case 3:
		if (lpAlarm->iValueEx == 0)
		{
			sprintf(szLanCn, "485通道%u,槽位%u,变量号:%u,点号%u 报警值:%0.3f", lpAlarm->dwChanNo, lpAlarm->dwSubChanNo, lpAlarm->dwVariableNo, lpAlarm->dwPointNo, (float)((float)(lpAlarm->iValue) / dwDivisionCoefficient));
			break;
		}
		else
		{
			iValueTemp = lpAlarm->iValueEx << 31 | (lpAlarm->iValue & 0xEFFFFFFF);
			sprintf(szLanCn, "485通道%u,槽位%u,变量号:%u,点号%u 报警值:%0.3f", lpAlarm->dwChanNo, lpAlarm->dwSubChanNo, lpAlarm->dwVariableNo, lpAlarm->dwPointNo, (float)((float)(iValueTemp) / dwDivisionCoefficient));
			break;
		}
	case 4:
		if (lpAlarm->iValueEx == 0)
		{
			sprintf(szLanCn, "网络通道%u,槽位号%u,变量号:%u,点号%u 报警值:%0.3f", lpAlarm->dwChanNo, lpAlarm->dwSubChanNo, lpAlarm->dwVariableNo, lpAlarm->dwPointNo, (float)((float)(lpAlarm->iValue) / dwDivisionCoefficient));
			break;
		} 
		else
		{
			iValueTemp = lpAlarm->iValueEx << 31 | (lpAlarm->iValue & 0xEFFFFFFF);
			sprintf(szLanCn, "网络通道%u,槽位号%u,变量号:%u,点号%u 报警值:%0.3f", lpAlarm->dwChanNo, lpAlarm->dwSubChanNo, lpAlarm->dwVariableNo, lpAlarm->dwPointNo, (float)((float)(iValueTemp) / dwDivisionCoefficient));
			break;
		}		
	default:
...
void CClientDemoDlg::ProcGateAlarmHostData(WPARAM wParam, LPARAM lParam)
{
	...
	sprintf(szInfoBuf, "AlarmType:[%d] DevType[%d] DevStatus[%d] DevCtrlType[%d] AlarmTime[%d:%d:%d %d:%d:%d]\n",\
        struAlarm.byAlarmType, struAlarm.byExternalDevType, struAlarm.byExternalDevStatus, struAlarm.byExternalDevCtrlType, \
        struAlarm.struAlarmTime.wYear, struAlarm.struAlarmTime.byMonth, struAlarm.struAlarmTime.byDay, \
...
void CClientDemoDlg::ProcAudioException(WPARAM wParam, LPARAM lParam)//声音异常报警上传 2014-03-21
{
	...
	case 1:
		...
		break;
	case 2:
		g_StringLanType(szAlarmType, "声强陡升","Audio Input Mutation");
		break;
	case 3:
...
void CClientDemoDlg::ProcAccessCardAlarm(WPARAM wParam, LPARAM lParam)
{
 ...
 //   strcpy(szInfoBuf, szLan); 
...
#ifdef DEMO_LAN_CN
    const char *szCardType[] = { "未知卡", "普通卡", "特殊群体卡", "禁止名单卡", "巡更卡", "胁迫卡", "超级卡", "来宾卡", "解除卡" };
#else
    const char *szCardType[] = { "unknow", "normalcard", "accessibledcard", "blocklistcard", "nightwatchcard", "stresscard", "supercard", "guestcard" , "releasecard" };
#endif
    ...
    if (struAcsAlarmInfo.struAcsEventInfo.byMask != 0)
    {
        sprintf(szInfoBuf + strlen(szInfoBuf), " byMask:%d", struAcsAlarmInfo.struAcsEventInfo.byMask);
    }
    if (struAcsAlarmInfo.struAcsEventInfo.byHelmet != 0)
    {
        sprintf(szInfoBuf + strlen(szInfoBuf), " byHelmet:%d", struAcsAlarmInfo.struAcsEventInfo.byHelmet);
    }
    ...
    if (struAcsAlarmInfo.byAcsEventInfoExtend == 1)
    {
...
#ifdef DEMO_LAN_CN
        const char *szUserType[] = { "未知人", "普通人(主人)", "来宾(访客)", "禁止名单人", "管理员" };
#else
        const char *szUserType[] = { "unknow", "normal", "visitor", "blockList", "administrators" };
#endif
        ...
        const char *szCurrentVerifyMode[] = { "无效", "休眠", "刷卡+密码", "刷卡", "刷卡或密码", "指纹", "指纹+密码", \
            ...
            "人脸或密码", "工号+人脸+密码", "刷卡或人脸或人脸+刷卡", "人脸或指纹或密码", "虹膜", "人脸或指纹或刷卡或密码或虹膜", "人脸或刷卡或密码或虹膜"};
#else
        const char *szCurrentVerifyMode[] = { "invalid", "sleep", "cardAndPw", "card", "cardOrPw", "fp", "fpAndPw", \
            ...
            "faceOrPw", "employeeNoAndFaceAndPw", "cardOrFaceOrFaceAndCard", "faceOrFpOrPw", "iris", "faceOrFpOrPwOrIris", "faceOrCardOrPwOrIris"};
#endif
        ...
        if (struAcsEventInfoExtend.byPurePwdVerifyEnable == 1)
        {
            sprintf(szInfoBuf + strlen(szInfoBuf), " deviceSupportPurePasswordAuth");
        }
    ...
    if (struAcsAlarmInfo.byAcsEventInfoExtendV20 == 1)
    {
        ...
        {
            sprintf(szInfoBuf + strlen(szInfoBuf), " remote check:%d", struAcsEventInfoExtendV20.byRemoteCheck);
        }
        if (struAcsEventInfoExtendV20.fCurrTemperature != 0)
        {
            sprintf(szInfoBuf + strlen(szInfoBuf), " temperature[%.3f]fX[%.3f]fY[%.3f]byThermometryUnit[%d]byIsAbnomalTemperature[%d]", struAcsEventInfoExtendV20.fCurrTemperature, \
                struAcsEventInfoExtendV20.struRegionCoordinates.fX, struAcsEventInfoExtendV20.struRegionCoordinates.fY, struAcsEventInfoExtendV20.byThermometryUnit, struAcsEventInfoExtendV20.byIsAbnomalTemperature);
        }
        if (struAcsEventInfoExtendV20.byAttendanceLabel[0] != 0)
        {
            if (g_struDeviceInfo[iDeviceIndex].byCharaterEncodeType == ENUM_MEM_CHAR_ENCODE_UTF8)
            {
               std::string strLabel = UTF82ASCII((char*)struAcsEventInfoExtendV20.byAttendanceLabel);
               sprintf(szInfoBuf + strlen(szInfoBuf), " AttendanceLabel:%s", strLabel.c_str());
            }
            else
            {
                sprintf(szInfoBuf + strlen(szInfoBuf), " AttendanceLabel:%s", (char*)struAcsEventInfoExtendV20.byAttendanceLabel);
            }
        }

        //人脸框信息
        sprintf(szInfoBuf + strlen(szInfoBuf), " XCoordinate[%d]YCoordinate[%d]Width[%d]Height[%d]", struAcsEventInfoExtendV20.wXCoordinate, struAcsEventInfoExtendV20.wYCoordinate, \
            struAcsEventInfoExtendV20.wWidth, struAcsEventInfoExtendV20.wHeight);

        //健康信息
        sprintf(szInfoBuf + strlen(szInfoBuf), " HealthCode[%d]NADCode[%d]TravelCode[%d]VaccineStatus[%d]", struAcsEventInfoExtendV20.byHealthCode, \
            struAcsEventInfoExtendV20.byNADCode, struAcsEventInfoExtendV20.byTravelCode, struAcsEventInfoExtendV20.byVaccineStatus);
    }
    ...
    if (struAcsAlarmInfo.byAcsEventInfoExtendV20 == 1)
    {
        if (struAcsEventInfoExtendV20.dwQRCodeInfoLen > 0 && struAcsEventInfoExtendV20.pQRCodeInfo != NULL)
        {
            int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
            ...
            sprintf(cFilename, "%s\\%s[%d]", g_struLocalParam.chPictureSavePath, "ACS_Alarm_Pic", num);
            if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
            {
                CreateDirectory(cFilename, NULL);
            }

            sprintf(cFilename, "%s\\QRCodeInfo[%s]Major[%d]Minor[%d]NetUser[%s]_%d.txt", cFilename, chTime, \
                struAcsAlarmInfo.dwMajor, struAcsAlarmInfo.dwMinor, struAcsAlarmInfo.sNetUser, rand() % GetTickCount());
            ...
            WriteFile(hFile, struAcsEventInfoExtendV20.pQRCodeInfo, struAcsEventInfoExtendV20.dwQRCodeInfoLen, &dwReturn, NULL);
            CloseHandle(hFile);
            hFile = NULL;
        }
        if (struAcsEventInfoExtendV20.dwVisibleLightDataLen > 0 && struAcsEventInfoExtendV20.pVisibleLightData != NULL)
        {
            int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
            ...
            sprintf(cFilename, "%s\\VisibleLight[%s]Major[%d]Minor[%d]NetUser[%s]_%d.jpg", cFilename, chTime, \
                struAcsAlarmInfo.dwMajor, struAcsAlarmInfo.dwMinor, struAcsAlarmInfo.sNetUser, rand() % GetTickCount());
            ...
            WriteFile(hFile, struAcsEventInfoExtendV20.pVisibleLightData, struAcsEventInfoExtendV20.dwVisibleLightDataLen, &dwReturn, NULL);
            CloseHandle(hFile);
            hFile = NULL;
        }
        if (struAcsEventInfoExtendV20.dwThermalDataLen > 0 && struAcsEventInfoExtendV20.pThermalData != NULL)
        {
            int num = GetFileNum(iDeviceIndex, pAlarmDev->lCommand);
            ...
            sprintf(cFilename, "%s\\Thermal[%s]Major[%d]Minor[%d]NetUser[%s]_%d.jpg", cFilename, chTime, \
                struAcsAlarmInfo.dwMajor, struAcsAlarmInfo.dwMinor, struAcsAlarmInfo.sNetUser, rand() % GetTickCount());
            ...
            WriteFile(hFile, struAcsEventInfoExtendV20.pThermalData, struAcsEventInfoExtendV20.dwThermalDataLen, &dwReturn, NULL);
            CloseHandle(hFile);
            hFile = NULL;
        }
    }
    ...
    if (struAcsAlarmInfo.pPicData != NULL)
    {
        ...
        struAcsAlarmInfo.pPicData = NULL;
	}
    if (struAcsEventInfoExtendV20.pQRCodeInfo != NULL)
    {
        delete[](struAcsEventInfoExtendV20.pQRCodeInfo);
        struAcsEventInfoExtendV20.pQRCodeInfo = NULL;
    }
    if (struAcsEventInfoExtendV20.pVisibleLightData != NULL)
    {
        delete[](struAcsEventInfoExtendV20.pVisibleLightData);
        struAcsEventInfoExtendV20.pVisibleLightData = NULL;
    }
    if (struAcsEventInfoExtendV20.pThermalData != NULL)
    {
        delete[](struAcsEventInfoExtendV20.pThermalData);
        struAcsEventInfoExtendV20.pThermalData = NULL;
    }
    if (struAcsAlarmInfo.pAcsEventInfoExtend != NULL)
    {
        delete[](struAcsAlarmInfo.pAcsEventInfoExtend);
        struAcsAlarmInfo.pAcsEventInfoExtend = NULL;
    }
    if (struAcsAlarmInfo.pAcsEventInfoExtendV20 != NULL)
    {
        delete[](struAcsAlarmInfo.pAcsEventInfoExtendV20);
        struAcsAlarmInfo.pAcsEventInfoExtendV20 = NULL;
    }
}
...
void CClientDemoDlg::ProcAuxAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    for (int i = 0, j = 0; i < sizeof(sAlarmName); i++, j++)
    {
        if (sAlarmName[i] == '%')
        {
            sAlarmNameTemp[j++] = '%';
        }
        sAlarmNameTemp[j] = sAlarmName[i];
    }
    ...
    sprintf(szInfoBuf, "AuxAlarm Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] Type[%d] AlarmName[%s]\n",
        ...
        time.GetMinute(), time.GetSecond(), struAuxAlarm.byAlarmType, sAlarmNameTemp);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
}
...
void CClientDemoDlg::ProcITSPlateAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    //重新拷贝，解决48个字节时，打印乱码的问题
    BYTE   tempMonitoringSiteID[MONITORSITE_ID_LEN + 1/*49*/] = { 0 };
    memcpy(tempMonitoringSiteID, struPlateResult.byMonitoringSiteID, sizeof(struPlateResult.byMonitoringSiteID));
    BYTE   tempDeviceID[DEVICE_ID_LEN + 1/*49*/] = { 0 };
    memcpy(tempDeviceID, struPlateResult.byDeviceID, sizeof(struPlateResult.byDeviceID));
	...
	sprintf(szInfoBuf, "ITS Plate Alarm Channel NO[%d] DriveChan[%d] IllegalFromatType[%d]IllegalInfo[%s]Analysis[%d]YellowLabel[%d]DangerousVeh[%d]MatchNo[%d]IllegalType[%d]IllegalSubType[%s]\
	  MonitoringSiteID[%s]DeviceID[%s]Dir[%d]CarDirectionType[%d]PicNum[%d] DetSceneID[%d] VehicleType[%d] DetectType[%d] Type[%d] DataType[%d] CloseUpType[%d]", \
        ...
        struPlateResult.byIllegalSubType, tempMonitoringSiteID, tempDeviceID,
    ...
    sprintf(szInfoBuf, "ITS Plate Alarm PlateInfo PlateType[%d]Color[%d]Bright[%d]LicenseLen[%d]EntireBelieve[%d]Region[%d]Country[%d]  wCRIndex[%d] Area[%d] PlateSize[%d]PlateCategory[%s]License[%s]PlateRect[x-%.3f y-%.3f w-%.3f h-%.3f] \
       ...
       struPlateResult.struPlateInfo.byLicenseLen, struPlateResult.struPlateInfo.byEntireBelieve, struPlateResult.struPlateInfo.byRegion, struPlateResult.struPlateInfo.byCountry, struPlateResult.struPlateInfo.wCRIndex,
	...
	for (i = 0; i < 6; i++)
	{
		...
		{
			sprintf(szInfoBuf, "ITS picture[%d] info Type[%d] RedLightTime[%d] AbsTime[%s %2.2d%2.2d] flag[%d]  CloseUpType[%d]PlateRect[x-%.3f y-%.3f w-%.3f h-%.3f]PlateRecgRect[x-%.3f y-%.3f w-%.3f h-%.3f]", i+1, struPlateResult.struPicInfo[i].byType,
			...
			{
                sprintf(cFilename, "%s\\UnloginIP[%d]_channel[%d]_ITS", g_struLocalParam.chPictureSavePath, iPort, struPlateResult.byChanIndex);
			}
			if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
			{
				CreateDirectory(cFilename, NULL);
            ...
            switch (struPlateResult.struPicInfo[i].byType)
            {
            case 0:
                sprintf(cPicType, "License");
                break;
            case 1:
                ...
                break;
            case 2:
                sprintf(cPicType, "Composition");
                break;
            case 3:
                sprintf(cPicType, "Feature");
                break;
            case 4:
                sprintf(cPicType, "Binary");
                break;
            case 5:
                sprintf(cPicType, "Stream");
                break;
            case 6:
                sprintf(cPicType, "FacePilot");
                break;
            case 7:
                sprintf(cPicType, "FaceCopilot");
                break;
            case 8:
                sprintf(cPicType, "NonMotor");
                break;
            case 9:
                sprintf(cPicType, "Human");
                break;
            case 10:
                sprintf(cPicType, "Weigh");
                break;
            case 11:
                sprintf(cPicType, "Target");
                break;
            case 12:
                sprintf(cPicType, "Pilot");
                break;
            case 13:
                sprintf(cPicType, "Copilot");
                break;
            case 14:
                sprintf(cPicType, "Face");
                break;
            case 15:
                ...
                break;
            case 16:
                sprintf(cPicType, "Secondary license");
                break;
            default:
                sprintf(cPicType, "Unknown");
                break;
            }
    ...
    if (struPlateResult.struPlateInfo.dwXmlLen > 0)
    {
        ...
        if (iDeviceIndex != -1 && iDeviceIndex < 512)
        {
            sprintf(sXMLFileName, "%s\\%s[%d]_channel[%d]_ITS", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, struPlateResult.byChanIndex);
        }
        else
        {
            sprintf(sXMLFileName, "%s\\UnloginIP[%d]%s_channel[%d]_ITS", g_struLocalParam.chPictureSavePath,  iPort, struPlateResult.byChanIndex);
        }
        if (GetFileAttributes(sXMLFileName) != FILE_ATTRIBUTE_DIRECTORY)
        {
            CreateDirectory(sXMLFileName, NULL);
    ...
    if (1 == struPlateResult.struPlateInfo.byAddInfoFlag)
    {
        ...
        sprintf(szInfoBuf, "AddInfoFlag [%d] LatitudeType [%d] Degree[%d] Minute[%d] fSec[%.3f] \
            LongitudeType [%d] Degree[%d] Minute[%d] fSec[%.3f] VehicleNo[%s] byVehicleMonitorTaskID[%s] byUUID[%s]",
...
void CClientDemoDlg::ProcITSPlateAlarmV50(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "ITS Plate Alarm V50;IsOverWeight[%d]AxleNum[%d]AxleModel[%d]OverWeight[%.3f]Weight[%.3f]LimitWeight[%.3f]AxleLen[%.3f]DevDescInfo[%s]\
    ...
    strInfo += "]";
    sprintf(szInfoBuf, " \nLength[%d]Width[%d]Height[%d]TollwayVehicleType[%d]", struPlateResult.struWeightResult.dwLength, struPlateResult.struWeightResult.dwWidth, struPlateResult.struWeightResult.dwHeight, struPlateResult.struWeightResult.byTollwayVehicleType);
    strInfo += szInfoBuf;
    ...
    if (struPlateResult.struPlateInfo.dwXmlLen > 0 && struPlateResult.struPlateInfo.pXmlBuf != NULL)
    {
        char cFilename[256] = { 0 };
        ...
        sprintf(cFilename, "%s\\XmlBuf_LocalTime[%s].XML", cFilename, chTime);
        ...
        WriteFile(hFile, struPlateResult.struPlateInfo.pXmlBuf, struPlateResult.struPlateInfo.dwXmlLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }
}
...
void CClientDemoDlg::ProcITSParkVehicle(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "ITS Park Vehicle LocationStatus[%d] MonitoringSiteID[%s] DeviceID[%s] PicNum[%d] struPlateRect0[%.3f,%.3f,%.3f,%.3f] struPlateRect1[%.3f,%.3f,%.3f,%.3f]  CurrentWorkerNumber[%d] CurrentGoodsLoadingRate[%d] DoorsStatus[%d]", \
    ...
    for (i = 0; i < 2; i++)
    {
        if (struParkVehicle.struPicInfo[i].dwDataLen > 0 && struParkVehicle.struPicInfo[i].pBuffer != NULL)
        {
            ...
            sprintf(cFilename, "%s\\%s[%d]", g_struLocalParam.chPictureSavePath, pAlarmDev->sDeviceIP, struParkVehicle.dwChanIndex);
            if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
            {
                CreateDirectory(cFilename, NULL);
            }

            if (struParkVehicle.struPicInfo[i].byDataType == 1)
            {
                sprintf(cFilename, "%s\\LocalTimeITSParkVehicle[%s]_%d_%d.txt", cFilename, chTime, i, GetAlarmNum());
            }
            else
            {
                sprintf(cFilename, "%s\\LocalTimeITSParkVehicle[%s]_%d_%d.jpg", cFilename, chTime, i, GetAlarmNum());
            }
            hFile = CreateFile(cFilename, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
            if (hFile == INVALID_HANDLE_VALUE)
            {
...
void CClientDemoDlg::ProcITSBalckListInfo(WPARAM wParam, LPARAM lParam)
{
	...
	NET_ITS_ECT_BLOCKLIST struBlockList = {0};
	memcpy(&struBlockList, pAlarmInfo, sizeof(struBlockList));
	
	sprintf(szInfoBuf, "ITS BLOCK LIST INFO Channel[%d] LogicalLaneNo[%d] LaneName[%d] License[%s]",\
		struBlockList.dwChannel, struBlockList.bylogicalLaneNo, struBlockList.bylogicalLaneNo, struBlockList.struPlateInfo.sLicense);
	g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
}
...
void CClientDemoDlg::ProcVehicleControlListDS(WPARAM wParam, LPARAM lParam)
{
    ...
    int iDeviceIndex = pAlarmDev->iDeviceIndex;
    char szLan[128] = { 0 };
    g_StringLanType(szLan, "车辆名单数据需要同步报警上传", "Vehicle control list");
...
void CClientDemoDlg::ProcVehicleControl(WPARAM wParam, LPARAM lParam)
{
    ...
    char szLan[128] = { 0 };
    g_StringLanType(szLan, "名单车辆报警上传", "Vehicle control");
    ...
    if (pVehicle->dwPicDataLen > 0 && pVehicle->pPicData != NULL)
    {
        char cFilename[256] = { 0 };
        DWORD dwWrittenBytes = 0;
        sprintf(cFilename, "%s\\%s[%d][%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, "blockallowlist");
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
            CreateDirectory(cFilename, NULL);
        }
...
LRESULT CClientDemoDlg::OnWMProcAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    case COMM_SCENECHANGE_DETECTION_UPLOAD://2013-07-17场景变更侦测报警
        ...
        break;
    case COMM_FACECAPTURE_STATISTICS_RESULT://目标抓拍统计上传
    ...
    case COMM_VCA_ADAS_ALARM:
        ...
        break;
    case COMM_VCA_ATTEND_ALARM:
        ProcessVcaAttendAlarm(wParam, lParam);
        break;
    ...
    case COMM_UPLOAD_AIOP_POLLING_VIDEO:
        ...
        break;
    case COMM_UPLOAD_AIOP_HISTORY_VIDEO:
        ProcAIOPHistoryVideo(wParam, lParam);
        break;
    case COMM_ALARM_EXCEPTION:
        ProcAlarmException(wParam, lParam);
        break;
	default:
		break;
	}
...
{	
	...
	default:
        ...
        {
            DWORD dwMErrorCode = 0, dwMErrDevSelfEx = 0;
            NET_DVR_GetLastErrorModelCode(&dwMErrorCode, &dwMErrDevSelfEx);
            sprintf(szErrInfo, "err[%d:%s][0x%08x,0x%08x]", NET_DVR_GetLastError(), NET_DVR_GetErrorMsg(), dwMErrorCode, dwMErrDevSelfEx);
        }
		break;
	}
...
void CClientDemoDlg::CyclePlayAllDevicesLogined()
{
	...
	if (g_nVideoSecurityTotalNum == g_iNextVideoSecurityIndex)		//turn to first page while cycle to last page
	{
	...
	{
		iPlayNum = g_nVideoSecurityTotalNum - g_iNextVideoSecurityIndex;
		
		if (iPlayNum > m_iCurWndNum)
		{
			iPlayNum = m_iCurWndNum;
		}
		iFirstIndex = g_iNextVideoSecurityIndex;
	}
	...
	iVideoSecurityNumLeft = g_nVideoSecurityTotalNum - g_iNextVideoSecurityIndex;
	
	if (iVideoSecurityNumLeft == 0)//restart afer a cycle
	{
		g_iNextVideoSecurityIndex = m_iCurWndNum;
		g_struLocalParam.bFrontPage = FALSE;
		g_struLocalParam.bNextPage = TRUE;
	}
	else if (iVideoSecurityNumLeft <= m_iCurWndNum)//last several monitoring points
	{
		g_iNextVideoSecurityIndex = g_nVideoSecurityTotalNum;
		g_struLocalParam.bNextPage = FALSE;
...
void CClientDemoDlg::PlayNextPage()
{
	...
	iVideoSecurityLeftNum = g_nVideoSecurityTotalNum - g_iNextVideoSecurityIndex;
	if (iVideoSecurityLeftNum > m_iCurWndNum)
	...
	{
		iPlayNum = iVideoSecurityLeftNum;
		g_struLocalParam.bNextPage = FALSE;
	}
	...
	for (i=0;i<iPlayNum;i++)
	{
		if (i+g_iNextVideoSecurityIndex < MAX_PREVIEWS)
		{
			iDeviceIndex = g_struPlayAllInfo[i+g_iNextVideoSecurityIndex].iDeviceIndex;
			iChanIndex = g_struPlayAllInfo[i+g_iNextVideoSecurityIndex].iChanIndex;
			g_dlgOutput[i].StartPlay(&g_struDeviceInfo[iDeviceIndex].pStruChanInfo[iChanIndex], GetChanItem(iDeviceIndex, iChanIndex));
			Sleep(100);
		}
	}
	
	g_iNextVideoSecurityIndex += iPlayNum;
	g_struLocalParam.bFrontPage = TRUE;
	ChangePlayBtnState();
	UpdateData(FALSE);
}
...
void CClientDemoDlg::PlayFrontPage()
{
	...
	if (g_iNextVideoSecurityIndex <= m_iCurWndNum || m_iCurWndNum == 0)
	{
		return;
	}
	...
	if (g_iNextVideoSecurityIndex < 2*m_iCurWndNum)
	{
		iPlayIndex = 0;//if front page is first index, set play index as 0
	}
	else
	{
		i = g_iNextVideoSecurityIndex % m_iCurWndNum;
		if (i == 0)
		{
			iPlayIndex = g_iNextVideoSecurityIndex - 2*m_iCurWndNum ;
		}
		else
		{
			iPlayIndex = g_iNextVideoSecurityIndex - m_iCurWndNum - i;
		}
	}
...
void CClientDemoDlg::OnMove(int x, int y) 
{
	...
	if (dwNewDeviceNum != g_dwOldDeviceNum)
	{
		if (m_iMainType == PREVIEW_T)
		{
			...
			if (g_nVideoSecurityTotalNum < m_iCurWndNum)
			{
				iPlayNum = g_nVideoSecurityTotalNum;
			}
			else
			{
				iPlayNum = g_nVideoSecurityTotalNum;
...
void CClientDemoDlg::OnMenuKeylog()
{
    CDlgKeylogCfg dlg;
    dlg.DoModal();
}
...
void CClientDemoDlg::OnMenuBroadCast()
{
    ...
    lUserID = g_struDeviceInfo[GetCurDeviceIndex()].lLoginID;

    if (GetCurChanIndex() >= 0)
    {
        lChannel = g_struDeviceInfo[GetCurDeviceIndex()].pStruChanInfo[GetCurChanIndex()].iChannelNO;
    }
    
    CBroadCast dlg;

    dlg.m_lChannel = lChannel;
    dlg.m_lUserID = lUserID;
...
void CClientDemoDlg::OnBnClickedBtnExit()
{
	...
	if (IDOK != MessageBox(szLan,"Warning",IDOK))
#else
    if (IDOK != MessageBoxEx(NULL, szLan, "Warning", IDOK, MAKELANGID(LANG_ENGLISH, SUBLANG_ENGLISH_US)))
#endif
	{
        g_bExitDemo = FALSE;
		return;
...
// 		}
		...
		g_pMainDlg->AddLog(iDeviceIndex, OPERATION_SUCC_T, "NET_DVR_GET_IPALARMINCFG");
	} 
	else
	{
...
//	memset(&g_struDeviceInfo[iDeviceIndex].struAlarmOutCfg, 0, sizeof(NET_DVR_IPALARMOUTCFG));
	...
	{	//8000 device
		...
		g_pMainDlg->AddLog(iDeviceIndex, OPERATION_SUCC_T, "NET_DVR_GET_IPALARMOUTCFG_V40");
	} 
	else
	{
...
//         }
        else if (iGroupNO >= 0 && ((iIPChanCount + iGroupNO * MAX_CHANNUM_V30)  <  iIPChanNum) && (iIPChanCount < iIPChanNum))   
        {
            ...
            if (g_struDeviceInfo[iDeviceIndex].byLoginModeRes == 1 || (lpIPAccessCfgV40->struStreamMode[iIPChanIndex].uGetStream.struChanInfo.byIPID != 0 && lpIPAccessCfgV40->struStreamMode[iIPChanIndex].uGetStream.struChanInfo.byEnable == TRUE) \
                || (lpIPAccessCfgV40->struStreamMode[iIPChanIndex].uGetStream.struIPChan.wIPID != 0 && lpIPAccessCfgV40->struStreamMode[iIPChanIndex].uGetStream.struIPChan.byEnable == TRUE))
            {
...
void CClientDemoDlg::DoTestElseFunction()
{
	...
	CDlgDoTest dlg;
	dlg.m_iDeviceIndex = iDevIndex;
    dlg.m_lServerID = g_struDeviceInfo[iDevIndex].lLoginID;
	dlg.DoModal();
}
...
void CClientDemoDlg::ProVehicleRecogResult( WPARAM wParam, LPARAM lParam )
{
    ...
    sprintf(szInfoBuf, "%s:PostID[%d] PostTime{wYear[%d] byMonth[%d] byDay[%d] byHour[%d] byMinute[%d] bySecond[%d] wMilliSec[%d]}DataIndex[%s] TaskNo[%d]   PlateRect{fX[%.3f] fY[%.3f] fWidth[%.3f] fHeight[%.3f]} sLicense[%s] VehicleType[%d] ColorDepth[%d] CarColor[%d] \
            ...
            VehicleModel[%d] VehicleLogoRecogEx[%d] VehicleRect{fX[%.3f] fY[%.3f] fWidth[%.3f] fHeight[%.3f]} PilotRect{fX[%.3f] fY[%.3f] fWidth[%.3f] fHeight[%.3f]} CopilotRect{fX[%.3f] fY[%.3f] fWidth[%.3f] fHeight[%.3f]}", \
...
void CClientDemoDlg::ProSensorInfoAlarm(WPARAM wParam, LPARAM lParam)
{
	...
	sprintf(szInfoBuf, "%s: Time[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d] SensorName[%s] SensorChan[%s] Reboot[%d] PowerSupply[%d] StatusType[%d],\
		SensorType[%d] VoltageValue[%.3f] CurrentValue[%.3f] ActualValue[%.3f] Description[%s]", szLan, struSensorInfo.struTime.wYear, struSensorInfo.struTime.byMonth, \
...
void CClientDemoDlg::ProFirDetectionAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "flag[%d] %2.2d%2.2d] %s,FireScanWaitMode[%d] VisibleChannel[%d] RelativeTime:%d, AbsTime:%d, PTZ{PanPos:%d, TiltPos:%d, ZoomPos:%d}, PicDataLen:%d, DevInfo{DevIP:%s, Port:%d, Channel:%d, IvmsChannel:%d,  IvmsChannelEx:%d}, \
        FireMaxTemperature:%d, TargetDistance:%d, fireRectInfo{fX:%.3f,fY:%.3f,fWidth%.3f,fHeight%.3f}, fireMaxTemperaturePoint{fX:%.3f,fY:%.3f}, PTZEx{P:%.3f,T:%.3f,Z:%.3f,F:%d},AlarmSubType:%d",
    ...
    if (struFireDetection.byAlarmSubType > 0 && struFireDetection.pSmokeBuf != NULL)
    {
        ...
        sprintf_s(szSmokeInfoBuf, "SMOKEDELETECTION ALARM INFO: PTZPos{P:%.3f, T:%.3f, Z:%.3f, Focus:%d}, ThermalPTZPos{P:%.3f, T:%.3f, Z:%.3f, Focus:%d}, Latitude{Type:%d, Sec:%.3f, Degree:%d, Minute:%d}, Longitude{Type:%d, Sec:%.3f, Degree:%d, Minute:%d}, SmokePos{X:%.3f, Y:%.3f, Width:%.3f, Height:%.3f}",
...
void CClientDemoDlg::ProGISInfoAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "%s:PtzPos{PanPos:%.1fTiltPos:%.1fZoomPos:%.1f}RelTime:%dAbsTime:%dAzimuth:%.3fLongitudeType:%dLatitudeType:%dLongitude{Sec:%.6fDegree:%dMinute:%d}Latitude{Sec:%.6fDegree:%dMinute:%d}Horizontal:%.3fVertical:%.3fVisibleRadius:%.3fMaxView:%.3fSensor{Type:%dWidth:%.3fWidth:%.3fFold:%.3f}DevInfo{DevIP:%sPort:%dChan:%dIvmsChan:%d}", 
...
void CClientDemoDlg::ProcVideoIntercomEvent(WPARAM wParam,LPARAM lParam)
{
    ...
    {
        sprintf(szInfoBuf, "Video Intercom Event Time[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] DevNumber[%s] EventType[%d] AuthResult[%d] AuthType[%d] CardNo[%s] EmployeeNo[%s]",
            ...
            struVideoIntercomEvent.uEventInfo.struAuthInfo.byAuthType, struVideoIntercomEvent.uEventInfo.struAuthInfo.byCardNo,struVideoIntercomEvent.uEventInfo.struAuthInfo.byEmployeeNo);
    }
    ...
    {
        sprintf(szInfoBuf, "Video Intercom Event Time[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] DevNumber[%s] EventType[%d], Mask[%d], FloorNumber[%d], RoomNumber[%d], LockID[%d],LockName[%s],EmployeeNo[%s]",
            struVideoIntercomEvent.struTime.wYear, struVideoIntercomEvent.struTime.byMonth, struVideoIntercomEvent.struTime.byDay,
            struVideoIntercomEvent.struTime.byHour, struVideoIntercomEvent.struTime.byMinute, struVideoIntercomEvent.struTime.bySecond,
            struVideoIntercomEvent.byDevNumber, struVideoIntercomEvent.byEventType,
            struVideoIntercomEvent.uEventInfo.struUnlockRecord.byMask,
    ...
    else if (struVideoIntercomEvent.byEventType == 8)
    {
        sprintf(szInfoBuf, "Video Intercom Event Time[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] DevNumber[%s] EventType[%d] MagneticDoorStatus[%d]",
            struVideoIntercomEvent.struTime.wYear, struVideoIntercomEvent.struTime.byMonth, struVideoIntercomEvent.struTime.byDay,
            struVideoIntercomEvent.struTime.byHour, struVideoIntercomEvent.struTime.byMinute, struVideoIntercomEvent.struTime.bySecond,
            struVideoIntercomEvent.byDevNumber, struVideoIntercomEvent.byEventType,
            struVideoIntercomEvent.uEventInfo.struMagneticDoorStatus.byMagneticDoorStatus);
    }
    else
    {
...
void CClientDemoDlg::ProcFacecaptureStatistics(WPARAM wParam, LPARAM lParam)//目标抓拍统计上传
{
	char szInfoBuf[1024] = {0}; 
	char szLan[128] = {0};
	LPLOCAL_ALARM_INFO pAlarmDev = (LPLOCAL_ALARM_INFO)(wParam);
	...
	g_StringLanType(szLan, "目标抓拍统计上传","Face Capture Statistics Upload");
	...
	{
		oldlen = sprintf(szInfoBuf+len,"%s","段有效");
	}
	...
	g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    char szTmpCN[200] = {0};
    sprintf(szTmpCN, "统计人数:%d,男:%d,女:%d", struFacecapture.dwPeopleNum, \
        struFacecapture.struSexGroupParam.dwMale, struFacecapture.struSexGroupParam.dwFemale);

    char szTmpEN[200] = {0};
    sprintf(szTmpEN, "PeopleNum:%d, male:%d, female:%d", struFacecapture.dwPeopleNum, \
        struFacecapture.struSexGroupParam.dwMale, struFacecapture.struSexGroupParam.dwFemale);
...
void CClientDemoDlg::ProcIDInfoAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    NET_DVR_ID_CARD_INFO_EXTEND struIDCardInfoExtend = { 0 };
    ...
    sprintf(szTriggerTime, "%s start,name:%s,\r\nAddr:%s\r\nIssuingAuthority:%s\r\nID:%s,%d-%d-%d\r\nbyCardType:%d\r\nbyCardReaderKind:%d", szLan, szName.c_str(), szAddr.c_str(), szIssuingAuthority.c_str(),
        ...
        struIDCardInfo.struIDCardCfg.struStartDate.byDay, struIDCardInfo.byCardType, struIDCardInfo.byCardReaderKind);

    if (struIDCardInfo.byMask != 0)
    {
        sprintf(szTriggerTime + strlen(szTriggerTime), " byMask:%d", struIDCardInfo.byMask);
    }
    sprintf(szTriggerTime + strlen(szTriggerTime), " byCurrentEvent:%d", struIDCardInfo.byCurrentEvent);
    sprintf(szTriggerTime + strlen(szTriggerTime), " dwSerialNo:%d", struIDCardInfo.dwSerialNo);
    sprintf(szTriggerTime + strlen(szTriggerTime), " byHelmet:%d", struIDCardInfo.byHelmet);
    if (struIDCardInfo.byIDCardInfoExtend == 1)
    {
        memcpy(&struIDCardInfoExtend, struIDCardInfo.pIDCardInfoExtend, sizeof(struIDCardInfoExtend));

        if (struIDCardInfoExtend.byRemoteCheck != 0)
        {
            sprintf(szTriggerTime + strlen(szTriggerTime), " remote check:%d", struIDCardInfoExtend.byRemoteCheck);
        }
        if (struIDCardInfoExtend.fCurrTemperature != 0)
        {
            sprintf(szTriggerTime + strlen(szTriggerTime), " temperature[%.3f]fX[%.3f]fY[%.3f]byThermometryUnit[%d]byIsAbnomalTemperature[%d]", struIDCardInfoExtend.fCurrTemperature, \
                struIDCardInfoExtend.struRegionCoordinates.fX, struIDCardInfoExtend.struRegionCoordinates.fY, struIDCardInfoExtend.byThermometryUnit, struIDCardInfoExtend.byIsAbnomalTemperature);
        }

        //人脸框信息
        sprintf(szTriggerTime + strlen(szTriggerTime), "XCoordinate[%d]YCoordinate[%d]Width[%d]Height[%d]", struIDCardInfoExtend.wXCoordinate, struIDCardInfoExtend.wYCoordinate, \
            struIDCardInfoExtend.wWidth, struIDCardInfoExtend.wHeight);

        //健康信息
        sprintf(szTriggerTime + strlen(szTriggerTime), " HealthCode[%d]NADCode[%d]TravelCode[%d]VaccineStatus[%d]", struIDCardInfoExtend.byHealthCode, \
            struIDCardInfoExtend.byNADCode, struIDCardInfoExtend.byTravelCode, struIDCardInfoExtend.byVaccineStatus);
    }
    ...
    do
    {
        ...
        if (struIDCardInfo.dwCapturePicDataLen > 0 && struIDCardInfo.pCapturePicData != NULL)
        {
            ...
            sprintf(cFilename, "%s\\LocalTime[%s]_CapturePic_%d.jpg", cFilename, chTime, rand() % GetTickCount());
        ...
        //证件抓拍图片数据
        if (struIDCardInfo.dwCertificatePicDataLen > 0 && struIDCardInfo.pCertificatePicData != NULL)
        {
            char cFilename[256] = { 0 };
            DWORD dwWrittenBytes = 0;
            sprintf(cFilename, "%s\\%s[%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, "Sensor");
            ...
            sprintf(cFilename, "%s\\LocalTime[%s]_CertificateCapturePic_%d.jpg", cFilename, chTime, rand() % GetTickCount());
            ...
            DWORD dwRet = WriteFile(hFile, struIDCardInfo.pCertificatePicData, struIDCardInfo.dwCertificatePicDataLen, &dwWrittenBytes, NULL);
            if (dwRet == 0 || dwWrittenBytes < struIDCardInfo.dwCertificatePicDataLen)
            {
                DWORD dwError = GetLastError();
                g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "ID Card Info Certificate Capture Picture Write to File Fail.System Error:%d, dwPicLen:%d, pBuffer:%d ", dwError, struIDCardInfo.dwCertificatePicDataLen, dwWrittenBytes);
            }
            CloseHandle(hFile);
            hFile = NULL;
        }
        ...
        if (struIDCardInfo.byIDCardInfoExtend == 1)
        {
            if (struIDCardInfoExtend.dwQRCodeInfoLen > 0 && struIDCardInfoExtend.pQRCodeInfo != NULL)
            {
                char cFilename[256] = { 0 };
                DWORD dwWrittenBytes = 0;
                sprintf(cFilename, "%s\\%s[%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, "Sensor");
                ...
                sprintf(cFilename, "%s\\LocalTime[%s]_QRCodeInfo_%d.txt", cFilename, chTime, rand() % GetTickCount());
                ...
                DWORD dwRet = WriteFile(hFile, struIDCardInfoExtend.pQRCodeInfo, struIDCardInfoExtend.dwQRCodeInfoLen, &dwWrittenBytes, NULL);
                if (dwRet == 0 || dwWrittenBytes < struIDCardInfoExtend.dwQRCodeInfoLen)
                {
                    DWORD dwError = GetLastError();
                    g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "QR Code Info Write to File Fail.System Error:%d, dwPicLen:%d, pBuffer:%d ", dwError, struIDCardInfoExtend.dwQRCodeInfoLen, dwWrittenBytes);
                }
                CloseHandle(hFile);
                hFile = NULL;
            }
            if (struIDCardInfoExtend.dwVisibleLightDataLen > 0 && struIDCardInfoExtend.pVisibleLightData != NULL)
            {
                char cFilename[256] = { 0 };
                DWORD dwWrittenBytes = 0;
                sprintf(cFilename, "%s\\%s[%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, "Sensor");
                ...
                sprintf(cFilename, "%s\\LocalTime[%s]_VisibleLightPic_%d.jpg", cFilename, chTime, rand() % GetTickCount());
                ...
                DWORD dwRet = WriteFile(hFile, struIDCardInfoExtend.pVisibleLightData, struIDCardInfoExtend.dwVisibleLightDataLen, &dwWrittenBytes, NULL);
                if (dwRet == 0 || dwWrittenBytes < struIDCardInfoExtend.dwVisibleLightDataLen)
                {
                    DWORD dwError = GetLastError();
                    g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "Visible Light Data Write to File Fail.System Error:%d, dwPicLen:%d, pBuffer:%d ", dwError, struIDCardInfoExtend.dwVisibleLightDataLen, dwWrittenBytes);
                }
                CloseHandle(hFile);
                hFile = NULL;
            }
            if (struIDCardInfoExtend.dwThermalDataLen > 0 && struIDCardInfoExtend.pThermalData != NULL)
            {
                char cFilename[256] = { 0 };
                DWORD dwWrittenBytes = 0;
                sprintf(cFilename, "%s\\%s[%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, "Sensor");
                ...
                sprintf(cFilename, "%s\\LocalTime[%s]_ThermalPic_%d.jpg", cFilename, chTime, rand() % GetTickCount());
                ...
                DWORD dwRet = WriteFile(hFile, struIDCardInfoExtend.pThermalData, struIDCardInfoExtend.dwThermalDataLen, &dwWrittenBytes, NULL);
                if (dwRet == 0 || dwWrittenBytes < struIDCardInfoExtend.dwThermalDataLen)
                {
                    DWORD dwError = GetLastError();
                    g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "Thermal Data Write to File Fail.System Error:%d, dwPicLen:%d, pBuffer:%d ", dwError, struIDCardInfoExtend.dwThermalDataLen, dwWrittenBytes);
                }
                CloseHandle(hFile);
                hFile = NULL;
            }
    ...
    if (struIDCardInfo.pCertificatePicData != NULL)
    {
        delete[](struIDCardInfo.pCertificatePicData);
        struIDCardInfo.pCertificatePicData = NULL;
    }
    if (struIDCardInfoExtend.pQRCodeInfo != NULL)
    {
        delete[](struIDCardInfoExtend.pQRCodeInfo);
        struIDCardInfoExtend.pQRCodeInfo = NULL;
    }
    if (struIDCardInfoExtend.pVisibleLightData != NULL)
    {
        delete[](struIDCardInfoExtend.pVisibleLightData);
        struIDCardInfoExtend.pVisibleLightData = NULL;
    }
    if (struIDCardInfoExtend.pThermalData != NULL)
    {
        delete[](struIDCardInfoExtend.pThermalData);
        struIDCardInfoExtend.pThermalData = NULL;
    }
    if (struIDCardInfo.pIDCardInfoExtend != NULL)
    {
        delete[](struIDCardInfo.pIDCardInfoExtend);
        struIDCardInfo.pIDCardInfoExtend = NULL;
    }
}
...
void CClientDemoDlg::ProcShipsDetAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    if (struShipsDetection.dwXmlLen > 0)
    {
        char sXMLFileName[256] = { 0 };
        DWORD dwWrittenBytes = 0;
        sprintf(sXMLFileName, "%s\\%s[%d][%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, "EventNotificationAlert");
        ...
        sprintf(sXMLFileName, "%s\\LocalTime[%s]_%d.xml", sXMLFileName, chTime, rand() % GetTickCount());
        ...
        DWORD dwRet = WriteFile(hXMLFile, struShipsDetection.pXmlBuf, struShipsDetection.dwXmlLen, &dwWrittenBytes, NULL);
        if (dwRet == 0 || dwWrittenBytes < struShipsDetection.dwXmlLen)
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "EventNotificationAlert xml Write to File Fail.System Error:%d, XmlLen:%d, dwWrittenBytes:%d ", 
                dwError, struShipsDetection.dwXmlLen, dwWrittenBytes);
        }
        CloseHandle(hXMLFile);
        hXMLFile = NULL;
    }
    for (int i = 0; i < MAX_SHIPIMAGE_NUM; i++)
    {
        if (struShipsDetection.struShipImageInfo[i].dwShipImageLen > 0)
        {
            char cFilename[256] = { 0 };
            DWORD dwWrittenBytes = 0;
            sprintf(cFilename, "%s\\%s[%d][%s]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName, iPort, "CaptureImage");
            if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
            {
                CreateDirectory(cFilename, NULL);
            }
            ...
            DWORD dwRet = WriteFile(hFile, struShipsDetection.struShipImageInfo[i].pXmlBuf, struShipsDetection.struShipImageInfo[i].dwShipImageLen, &dwWrittenBytes, NULL);
            if (dwRet == 0 || dwWrittenBytes < struShipsDetection.struShipImageInfo[i].dwShipImageLen)
            {
                DWORD dwError = GetLastError();
                g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "CaptureImage Write to File Fail.System Error:%d, ImageLen:%d, dwWrittenBytes:%d ", 
                    dwError, struShipsDetection.struShipImageInfo[i].dwShipImageLen, dwWrittenBytes);
            }
            CloseHandle(hFile);
            hFile = NULL;
        }
    ...
    //释放报文内存
    if (struShipsDetection.pXmlBuf != NULL)
    {
        delete[](struShipsDetection.pXmlBuf);
        struShipsDetection.pXmlBuf = NULL;
    }
    //释放抓拍图片内存
    for (int i = 0; i < MAX_SHIPIMAGE_NUM; i++) 
    {
        if (struShipsDetection.struShipImageInfo[i].pXmlBuf != NULL)
        {
            delete[](struShipsDetection.struShipImageInfo[i].pXmlBuf);
            struShipsDetection.struShipImageInfo[i].pXmlBuf = NULL;
        }
    }
}
void CClientDemoDlg::shipsDetectionToTxt(LPNET_DVR_SHIPSDETECTION_ALARM pShipsDetection, int iDeviceIndex)
{
   ...
   // sprintf(cFilename, "%s\\LocalTime[%s].txt", cFilename, chLocalTime);
    ...
    WriteFile(hFile, sInfo, strlen(sInfo), &dwReturn, NULL);
    CloseHandle(hFile);
    hFile = NULL;
...
void CClientDemoDlg::ProThermometryAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    NET_DVR_TIME  struRelativeTime = { 0 };
    struRelativeTime.dwYear = GET_YEAR(struThermometryAlarm.dwRelativeTime);
    struRelativeTime.dwMonth = GET_MONTH(struThermometryAlarm.dwRelativeTime);
    struRelativeTime.dwDay = GET_DAY(struThermometryAlarm.dwRelativeTime);
    struRelativeTime.dwHour = GET_HOUR(struThermometryAlarm.dwRelativeTime);
    struRelativeTime.dwMinute = GET_MINUTE(struThermometryAlarm.dwRelativeTime);
    struRelativeTime.dwSecond = GET_SECOND(struThermometryAlarm.dwRelativeTime);


    if (0 == struThermometryAlarm.byRuleCalibType)
    {
        sprintf(szInfoBuf, "%s: Channel:%d,fAlarmRuleTemperature:%.3f,Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] ,Relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d],VisibleChannel:%d, RuleID:%d,TemperatureSuddenChangeCycle:%d; TemperatureSuddenChangeValue:%.3f;  ToleranceTemperature:%.3f, AlertFilteringTime:%d, AlarmFilteringTime:%d,ThermometryUnit:%d, PresetNo:%d, RuleTemperature:%.1f, CurrTemperature:%.1f, PTZ Info[Pan:%.3f, Tilt:%.3f, Zoom:%.3f], AlarmLevel:%d, \
                                                                  AlarmType:%d, AlarmRule:%d, RuleCalibType:%d,  Point[x:%.3f, y:%.3f], PicLen:%d, ThermalPicLen:%d, ThermalInfoLen:%d", szLan, \
                                                                  struThermometryAlarm.dwChannel, struThermometryAlarm.fAlarmRuleTemperature, struAbsTime.dwYear, struAbsTime.dwMonth, struAbsTime.dwDay, struAbsTime.dwHour, struAbsTime.dwMinute, struAbsTime.dwSecond, struRelativeTime.dwYear, struRelativeTime.dwMonth, struRelativeTime.dwDay, struRelativeTime.dwHour, struRelativeTime.dwMinute, struRelativeTime.dwSecond,struThermometryAlarm.dwVisibleChannel, struThermometryAlarm.byRuleID, struThermometryAlarm.dwTemperatureSuddenChangeCycle, struThermometryAlarm.fTemperatureSuddenChangeValue, struThermometryAlarm.fToleranceTemperature, struThermometryAlarm.dwAlertFilteringTime, struThermometryAlarm.dwAlarmFilteringTime, struThermometryAlarm.byThermometryUnit, struThermometryAlarm.wPresetNo, \
    ...
    else if (1 == struThermometryAlarm.byRuleCalibType || 2 == struThermometryAlarm.byRuleCalibType)
    {
        ...
        for (int i = 0; i < iPointNum; i++)
        {
            ...
            sprintf(szRegionInfo, "%sX%d:%.3f,Y%d:%.3f;", szRegionInfo, i + 1, fX, i + 1, fY);
        }

        sprintf(szInfoBuf, "%s: Channel:%d,fAlarmRuleTemperature:%.3f,Abs[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d] ,Relative[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d], RuleID:%d,TemperatureSuddenChangeCycle:%d; TemperatureSuddenChangeValue:%.3f; ToleranceTemperature:%.3f, AlertFilteringTime:%d, AlarmFilteringTime:%d,HighestPoint[x:%.3f, y:%.3f],ThermometryUnit:%d, PresetNo:%d, RuleTemperature:%.1f, CurrTemperature:%.1f, PTZ Info[Pan:%.3f, Tilt:%.3f, Zoom:%.3f], AlarmLevel:%d, \
                                                                  AlarmType:%d, AlarmRule:%d, RuleCalibType:%d,  Region[%s], PicLen:%d, ThermalPicLen:%d, ThermalInfoLen:%d", szLan, \
                                                                  struThermometryAlarm.dwChannel, struThermometryAlarm.fAlarmRuleTemperature, struAbsTime.dwYear, struAbsTime.dwMonth, struAbsTime.dwDay, struAbsTime.dwHour, struAbsTime.dwMinute, struAbsTime.dwSecond, struRelativeTime.dwYear, struRelativeTime.dwMonth, struRelativeTime.dwDay, struRelativeTime.dwHour, struRelativeTime.dwMinute, struRelativeTime.dwSecond, struThermometryAlarm.byRuleID, struThermometryAlarm.dwTemperatureSuddenChangeCycle, struThermometryAlarm.fTemperatureSuddenChangeValue, struThermometryAlarm.fToleranceTemperature, struThermometryAlarm.dwAlertFilteringTime, struThermometryAlarm.dwAlarmFilteringTime, struThermometryAlarm.struHighestPoint.fX, struThermometryAlarm.struHighestPoint.fY, struThermometryAlarm.byThermometryUnit, struThermometryAlarm.wPresetNo, \
...
void CClientDemoDlg::ProThermometryDiffAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    if (0 == struThermometryAlarm.byRuleCalibType)
    {
        sprintf(szInfoBuf, "%s: Channel:%d,VisibleChannel:%d, AlarmID1:%d, ToleranceTemperature:%.3f, AlarmFilteringTime:%d,AlarmID2:%d, PresetNo:%d, RuleTemperatureDiff:%.1f, CurTemperatureDiff:%.1f, \
                AlarmLevel:%d, AlarmType:%d, AlarmRule:%d, RuleCalibType:%d,  \
                Point1[x:%.3f, y:%.3f], point2[x:%.3f, y:%.3f], PTZ Info[Pan:%.3f, Tilt:%.3f, Zoom:%.3f], PicLen:%d, \
                ThermalPicLen:%d, ThermalInfoLen:%d, ThermometryUnit:%d", szLan, \
                struThermometryAlarm.dwChannel, struThermometryAlarm.dwVisibleChannel, struThermometryAlarm.byAlarmID1, struThermometryAlarm.fToleranceTemperature, struThermometryAlarm.dwAlarmFilteringTime, struThermometryAlarm.byAlarmID2, struThermometryAlarm.wPresetNo, \
    ...
    else if (1 == struThermometryAlarm.byRuleCalibType || 2 == struThermometryAlarm.byRuleCalibType)
    {
        ...
        for (i = 0; i < iPointNum; i++)
        {
            ...
            sprintf(szRegionInfo, "%sX%d:%.3f,Y%d:%.3f;", szRegionInfo, iPointNum + 1, fX, iPointNum + 1, fY);
        }
        ...
        for (i = 0; i < iPointNum; i++)
        {
            ...
            sprintf(szRegionInfo1, "%sX%d:%.3f,Y%d:%.3f;", szRegionInfo1, iPointNum + 1, fX, iPointNum + 1, fY);
        }

        sprintf(szInfoBuf, "%s: Channel:%d, AlarmID1:%d, AlarmID2:%d,   ToleranceTemperature:%.3f, AlarmFilteringTime:%d,PresetNo:%d, RuleTemperatureDiff:%.1f, CurTemperatureDiff:%.1f, AlarmLevel:%d, AlarmType:%d, AlarmRule:%d, RuleCalibType:%d,  \
                                                       Region1[%s], Region2[%s], PTZ Info[Pan:%.3f, Tilt:%.3f, Zoom:%.3f], PicLen:%d, ThermalPicLen:%d, ThermalInfoLen:%d, ThermometryUnit:%d", szLan, \
...
void CClientDemoDlg::ProTagInfoUpload(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "%s Card No:[%s],Rssi:[%d],byIndexCode[%s],AcquisitionTime[%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d],RFIDInfo[%s],RFIDInfoLen[%d],byVoltageLow[%d],byAlarmFlag[%d],byDirection[%d]\n", 
        szLan, 
...
void CClientDemoDlg::ProcessInquestAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    case 1:
        ...
        break;
    case 2:
        g_StringLanType(szAlarmType, "审讯超时提醒", "Inquest Over Time Notification");
    default:
        break;
    }

    sprintf(szInfoBuf, "%s: (Alarm type:[%s]  Tray No.:[%d]   dwInquestTime:[%d]  dwNotifyChannel:[%d] )\n", 
        szLan, szAlarmType, struTrayAbnormalAlarm.byTrayNo, 
       struTrayAbnormalAlarm.dwInquestTime, struTrayAbnormalAlarm.dwNotifyChannel );
...
void CClientDemoDlg::ProcNetSwitchAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "%s Port:%d,PortEx:%d EventType:%d, Event:%d", szLan, struSwitchAlarm.byPortNo, struSwitchAlarm.byPortNoEx, struSwitchAlarm.dwEventType, struSwitchAlarm.dwEvent);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
}
...
void CClientDemoDlg::ProcessEventWithJsonData(WPARAM wParam, LPARAM lParam)
{
	...
	char* pCBBuf = new char[dwBufLen+1];
	if (pCBBuf == NULL)
	{
    ...
    sprintf(cFilename, "%s\\%s%s.txt", cFilename, "alarm_", chTime);

    HANDLE hFile = CreateFile(cFilename, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
    if (hFile != INVALID_HANDLE_VALUE)
    {
        DWORD dwWrittenBytes = 0;
        WriteFile(hFile, pAlarmInfo, dwBufLen, &dwWrittenBytes, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }

    memset(pCBBuf, 0, dwBufLen + 1);
	memcpy(pCBBuf, pAlarmInfo, dwBufLen);
	char *mfd = pCBBuf;
    string strEventType;
    string strTriggerType;
    bool bNonMotor = false;
    ...
    {
        strTriggerType = "";
        char *type = NULL, *content = NULL, *file = NULL;
        if (boundary)
        {
            mfd = mutipart_form_data(mfd, boundary, &type, &content, &file, (dwBufLen - offsetLen), contentLen, offsetLen);
            if (mfd == NULL) {
                break;
            }
        }
        ...
        {
            content = (char*)malloc(dwBufLen + 1);
            if (NULL == content)
            {
                break;
            }
            memset(content, 0, dwBufLen + 1);
            memcpy(content, pCBBuf, dwBufLen);
            if (type == NULL)
            {
                type = (char*)malloc(5);
                if (NULL == type)
        ...
        if (!root)
        {
            ...
            CXmlBase xmlBase;
            if (xmlBase.Parse(content) == NULL)
            {
                sprintf(szInfoBuf, "Parse failed");
            }
            else if (xmlBase.FindElem("EventNotificationAlert") && xmlBase.IntoElem() && xmlBase.FindElem("eventType"))
            {
                sprintf(szInfoBuf, "%s", xmlBase.GetData().c_str());
            }
            else
            {
                sprintf(szInfoBuf, "no eventType");
            }
            g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
        }
        else
        {
            ...
            cJSON *triggerType = cJSON_GetObjectItem(root, "triggerType");
            if (!eventType)
            {
            ...
            else
            {
                ...
                strEventType = eventType->valuestring;
                g_pMainDlg->AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
            }
            if (triggerType)
            {
                strTriggerType = triggerType->valuestring;
            }

            cJSON *channel = cJSON_GetObjectItem(root, "channel"); //兼容老报警，获取channel表示通道
            if (channel)
            {
                iChannelID = channel->valueint;
            }
            ...
            //区分机动车、非机动车
            cJSON *CaptureList = cJSON_GetObjectItem(root, "CaptureResult");
            if (CaptureList != NULL)
            {
                int  iCount = cJSON_GetArraySize(CaptureList);
                if (iCount > 0)
                {
                    cJSON *CaptureResult = cJSON_GetArrayItem(CaptureList, 0);
                    if (CaptureResult != NULL)
                    {
                        cJSON *NonMotor = cJSON_GetObjectItem(CaptureResult, "NonMotor");
                        if (NonMotor != NULL)
                        {
                            bNonMotor = true;
                        }
        ...
        char szFilename[128] = { 0 };
        dealFileName(file, szFilename, strEventType, bNonMotor, strTriggerType);
        sprintf(cFilename, "%s\\%s%s_%d.%s", cFilename, szFilename, chTime, i, type);
...
void CClientDemoDlg::dealFileName(char* szFile, char* szFilename, string strType, bool bNonMotor, string strTriggerType)
{
    char szType[32] = { 0 };
    if (strType == "mixedTargetDetection")//目前只支持混合目标和车位检测增加名称说明
    {
        g_StringLanType(szType, "混合目标", "MixedTargetDetection");
    }
    else if (strType == "PackingSpaceRecognition")
    {
        g_StringLanType(szType, "车位检测", "PackingSpaceRecognition");
    }
    else
    {
        return;
    ...
    string strFilename = "";
    if (strTriggerType != "")   //说明是json文件，使用trigger命名
    {
        strFilename = strTriggerType;
    }
    else if (szFile != NULL) //增加判空处理
    {
        strFilename = szFile;
    }
    ...
    { 
        while ((index = strFilename.find(' ', index)) != string::npos)
        {
            strFilename.erase(index, 1);
        } 
    }

    if(strFilename == "humanImage")
    {
        g_StringLanType(szLan, "人体-人体", "Human-Human");
    }
    else if (strFilename == "humanBackgroundImage")
    {
        g_StringLanType(szLan, "人体-背景图", "Human-Background");
    }
    else if (strFilename == "faceImage")
    {
        g_StringLanType(szLan, "人脸-人脸", "Face-Face");
    }
    else if (strFilename == "faceBackgroundImage")
    {
        g_StringLanType(szLan, "人脸-背景图", "Face-Background");
    }
    else if (strFilename == "nonMotorImage")
    {
        g_StringLanType(szLan, "非机动车-车身", "NonMotor-Vehicle");
    }
    else if (strFilename == "nonMotorBackgroundImage")
    {
        g_StringLanType(szLan, "非机动车-背景图", "NonMotor-Background");
    }
    else if (strFilename == "vehicleImage")
    {
        g_StringLanType(szLan, "机动车-车身", "Vehicle-Vehicle");
    }
    else if (strFilename == "vehicleBackgroundImage")
    {
        g_StringLanType(szLan, "机动车-背景图", "Vehicle-Background");
    }
    else if (strFilename == "plateImage")
    {
        if (bNonMotor)
        {
            g_StringLanType(szLan, "非机动车-车牌", "NonMotor-Plate");
        }
        else
        {
            g_StringLanType(szLan, "机动车-车牌", "Vehicle-Plate");
        }
    }
    else if (strFilename == "faceLibImage")
    {
        g_StringLanType(szLan, "人脸-小图", "Face-Lib");
    }
    else if (strFilename == "humanMergeImage")
    {
        g_StringLanType(szLan, "人体-细节图", "Human-Merge");
    }
    else if (strFilename == "otherImage")
    {
        g_StringLanType(szLan, "其他目标-小图", "Other");
    }
    else if (strFilename == "otherBackgroundImage")
    {
        g_StringLanType(szLan, "其他目标-背景图", "Other-Background");
    }
    else if (strFilename == "backgroundImage")
    {
        g_StringLanType(szLan, "背景图", "Background");
    }
    else if (strFilename == "vehicleBodyImage")
    {
        g_StringLanType(szLan, "机动车-车身", "Vehicle-Body");
    }
    else if (strFilename == "enter")
    {
        g_StringLanType(szLan, "驶入", "Enter");
    }
    else if (strFilename == "exit")
    {
        g_StringLanType(szLan, "驶出", "Exit");
    }
    else if (strFilename == "parkingTimeout")
    {
        g_StringLanType(szLan, "停车超时", "Parking-Timeout");
    }
    else if (strFilename == "insufficientRemainingSpace")
    {
        g_StringLanType(szLan, "余位不足", "Insufficient-Remaining-Space");
    }
    else if (strFilename == "parkingSpaceStatus")
    {
        g_StringLanType(szLan, "车位状态", "Parking-Space-Status");
    }
    else
    {
    ...
    sprintf(szFilename, "%s-%s", szType, szLan);
    return;
}
...
//         CloseHandle(hFile);
        ...
        ////////////////解析json数据,判断是否为人脸消费机事件/////////////////
        cJSON *root;
        root = cJSON_Parse(struISAPIAlarm.pAlarmData);
        ...
        else
        {
            ...
            if (eventType)
            {
                char byStr[32] = { 0 };
                memset(byStr, 0, 32);
                if (eventType != NULL && eventType->type == cJSON_String)
                {
                    strncpy(byStr, eventType->valuestring, strlen(eventType->valuestring));
                    if (strcmp(byStr,"TransactionRecordEvent") == 0)
                    {
                        //触发交易记录事件消息
                        memcpy(&g_struConsumeISAPIAlarm, pAlarmInfo, sizeof(NET_DVR_ALARM_ISAPI_INFO));
                        if (g_pDlgConsumeSimulate != NULL)
                        {
                            ::PostMessage(g_pDlgConsumeSimulate->m_hWnd, WM_PROC_TRANS_RECORD_ALARM, NULL, NULL);
                        }
                    }
                    else if (strcmp(byStr, "ConsumptionEvent") == 0)
                    {
                        //触发消费事件消息
                        memcpy(&g_struConsumeISAPIAlarm, pAlarmInfo, sizeof(NET_DVR_ALARM_ISAPI_INFO));
                        if (g_pDlgConsumeSimulate != NULL)
                        {
                            ::PostMessage(g_pDlgConsumeSimulate->m_hWnd, WM_PROC_CONSUME_ALARM, NULL, NULL);
                        }
                    }
                }
                else
        ...
        if (struISAPIAlarm.pPicPackData != NULL)
        {
            ...
            while (i <= struISAPIAlarm.byPicturesNumber - 1)
            {
                ...
                else if (2 == ((NET_DVR_ALARM_ISAPI_PICDATA *)struISAPIAlarm.pPicPackData)[i].byPicType)
                {
                    sprintf(cFilename, "%s\\AudioData[%s]_%s_%d.wav", cSubFilename, chTime, ((NET_DVR_ALARM_ISAPI_PICDATA *)struISAPIAlarm.pPicPackData)[i].szFilename, rand() % GetTickCount());
                }
                else if (3 == ((NET_DVR_ALARM_ISAPI_PICDATA *)struISAPIAlarm.pPicPackData)[i].byPicType)
                {
                    sprintf(cFilename, "%s\\VideoData[%s]_%s_%d.mp4", cSubFilename, chTime, ((NET_DVR_ALARM_ISAPI_PICDATA *)struISAPIAlarm.pPicPackData)[i].szFilename, rand() % GetTickCount());
                }
                else
                {
...
void CClientDemoDlg::OnMenuSearchAlarm()
{
    ...
    dlg.m_lHandle = g_pMainDlg->m_lAlarmInfoHandle;
    dlg.DoModal();
}
...
void CClientDemoDlg::ProcHeatMapResultPDC(WPARAM wParam, LPARAM lParam)//热度图按人数统计数据上传事件 2018-06-05
{
    ...
    if (struHeatMapResult.dwEventNotificationAlertLen > 0 && struHeatMapResult.pEventNotificationAlertBuff != NULL)
    {
        sprintf(cFilename, "%s\\%s", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        sprintf(cFilename, "%s\\EventNotificationAlert_[%s].json", cFilename, chTime);
        HANDLE hFile;
        DWORD dwReturn = 0;
        hFile = CreateFile(cFilename, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        if (hFile == INVALID_HANDLE_VALUE)
        ...
        WriteFile(hFile, struHeatMapResult.pEventNotificationAlertBuff, struHeatMapResult.dwEventNotificationAlertLen, &dwReturn, NULL);
        CloseHandle(hFile);
        hFile = NULL;
    }
    ...
    sprintf(szInfoBuf, "%s:[IP:%s Port:%d Channel:%d IvmsChannel:%d StartTime%d-%d-%d %d:%d:%d EndTime:%d-%d-%d %d:%d:%d BrokenNetHttp:%d] IvmsChannelEx[%d] CurNumber[%d] LeaveNumber[%d] SingleHeatMap[0]:ArrayLine:%d ArrayColumn:%d MaxHeatMapValue:%d MinHeatMapValue:%d TimeHeatMapValue:%d\
                                                          ...
                                                          struHeatMapResult.byArrayUnitType, struHeatMapResult.dwEventNotificationAlertLen);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
}
...
void CClientDemoDlg::ProcHeatMapResultDuration(WPARAM wParam, LPARAM lParam)//热度图按人员停留时间统计数据上传事件 2018-06-05
{
    ...
    sprintf(szInfoBuf, "%s:[IP:%s Port:%d Channel:%d IvmsChannel:%d StartTime%d-%d-%d %d:%d:%d flag[%d] %2.2d%2.2d] EndTime:%d-%d-%d %d:%d:%d %2.2d%2.2d] ArrayLine:%d ArrayColumn:%d HeatMapPath:%s \
                                                          MaxHeatMapValue:%d MinHeatMapValue:%d TimeHeatMapValue:%d DetSceneID:%d BrokenNetHttp:%dIvmsChannel[%d]IvmsChannelEx[%d]TotalTime[%d]]ArrayUnitType[%d]\n", \
                                                          szLan, struHeatMapResult.struDevInfo.struDevIP.sIpV4, struHeatMapResult.struDevInfo.wPort, struHeatMapResult.struDevInfo.byChannel, \
                                                          struHeatMapResult.struDevInfo.byIvmsChannel, struHeatMapResult.struStartTime.wYear, struHeatMapResult.struStartTime.byMonth, \
                                                          struHeatMapResult.struStartTime.byDay, struHeatMapResult.struStartTime.byHour, struHeatMapResult.struStartTime.byMinute, \
                                                          struHeatMapResult.struStartTime.bySecond, struHeatMapResult.byTimeDiffFlag, struHeatMapResult.cStartTimeDifferenceH, struHeatMapResult.cStartTimeDifferenceM, \
                                                          struHeatMapResult.struEndTime.wYear, struHeatMapResult.struEndTime.byMonth, struHeatMapResult.struEndTime.byDay, \
                                                          struHeatMapResult.struEndTime.byHour, struHeatMapResult.struEndTime.byMinute, struHeatMapResult.struEndTime.bySecond, struHeatMapResult.cStopTimeDifferenceH, \
                                                          struHeatMapResult.cStopTimeDifferenceM, struHeatMapResult.wArrayLine, struHeatMapResult.wArrayColumn, cFilename, struHeatMapResult.dwMaxHeatMapValue, \
                                                          struHeatMapResult.dwMinHeatMapValue, struHeatMapResult.dwTimeHeatMapValue, struHeatMapResult.byDetSceneID, struHeatMapResult.byBrokenNetHttp, \
                                                          struHeatMapResult.struDevInfo.byIvmsChannel, struHeatMapResult.wDevInfoIvmsChannelEx, struHeatMapResult.dwTotalTime, struHeatMapResult.byArrayUnitType);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
}
...
void CClientDemoDlg::ProcAIOPVideo(WPARAM wParam, LPARAM lParam)
{
    ...
    if (struHead.dwAIOPDataSize > 0 && struHead.pBufferAIOPData != NULL)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_DATA[%s].json", cFilename, chTime);
    ...
    else if (struHead.dwPictureSize > 0 && struHead.pBufferPicture != NULL)
    {
        sprintf(cFilename, "%s\\%s[AIOPVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        if (struHead.byPictureMode == 1)
        {
            sprintf(cFilename, "%s\\AIOPVideo_URL_PIC[%s].txt", cFilename, chTime);
        }
        else
        {
            sprintf(cFilename, "%s\\AIOPVideo_LOCAL_URL_PIC[%s].txt", cFilename, chTime);
        }
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwPictureSize, dwWrittenBytes);
        }
    ...
    if (struHead.dwAddInfoPictureSize > 0 && struHead.pAddInfoPictureBuffer != NULL && struHead.byPictureMode == 0)
    {
        sprintf(cFilename, "%s\\%s[AIOPVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_ADDINFO_Pic[%s].jpg", cFilename, chTime);
        ...
        DWORD dwWrittenBytes = 0;
        DWORD dwRet = WriteFile(hFile, struHead.pAddInfoPictureBuffer, struHead.dwAddInfoPictureSize, &dwWrittenBytes, NULL);
        if (dwRet == 0 || dwWrittenBytes < struHead.dwAddInfoPictureSize)
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwAddInfoPictureSize, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    else if (struHead.dwAddInfoPictureSize > 0 && struHead.pAddInfoPictureBuffer != NULL)
    {
        ...
        if (struHead.byPictureMode == 1)
        {
            sprintf(cFilename, "%s\\AIOPVideo_URL_ADDINFO_PIC[%s].txt", cFilename, chTime);
        }
        else
        {
            sprintf(cFilename, "%s\\AIOPVideo_LOCAL_URL_ADDINFO_PIC[%s].txt", cFilename, chTime);
        }
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwAddInfoPictureSize, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_URL_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    ...
    if (struHead.dwFacePicBuffLen > 0 && struHead.pFacePicBuff != NULL && struHead.byPictureMode == 0)
    {
        sprintf(cFilename, "%s\\%s[AIOPVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_FACE_Pic[%s].jpg", cFilename, chTime);
        ...
        DWORD dwWrittenBytes = 0;
        DWORD dwRet = WriteFile(hFile, struHead.pFacePicBuff, struHead.dwFacePicBuffLen, &dwWrittenBytes, NULL);
        if (dwRet == 0 || dwWrittenBytes < struHead.dwFacePicBuffLen)
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwFacePicBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    else if (struHead.dwFacePicBuffLen > 0 && struHead.pFacePicBuff != NULL)
    {
        sprintf(cFilename, "%s\\%s[AIOPVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        if (struHead.byPictureMode == 1)
        {
            sprintf(cFilename, "%s\\AIOPVideo_URL_FACE_PIC[%s].txt", cFilename, chTime);
        }
        else
        {
            sprintf(cFilename, "%s\\AIOPVideo_LOCAL_URL_FACE_PIC[%s].txt", cFilename, chTime);
        }
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwFacePicBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_URL_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    ...
    if (struHead.dwComparisonPicBuffLen > 0 && struHead.pComparisonPicBuff != NULL && struHead.byPictureMode == 0)
    {
        sprintf(cFilename, "%s\\%s[AIOPVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_COMPARISON_Pic[%s].jpg", cFilename, chTime);
        ...
        DWORD dwWrittenBytes = 0;
        DWORD dwRet = WriteFile(hFile, struHead.pComparisonPicBuff, struHead.dwComparisonPicBuffLen, &dwWrittenBytes, NULL);
        if (dwRet == 0 || dwWrittenBytes < struHead.dwComparisonPicBuffLen)
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwComparisonPicBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    else if (struHead.dwComparisonPicBuffLen > 0 && struHead.pComparisonPicBuff != NULL)
    {
        sprintf(cFilename, "%s\\%s[AIOPVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        if (struHead.byPictureMode == 1)
        {
            sprintf(cFilename, "%s\\AIOPVideo_URL_COMPARISON_PIC[%s].txt", cFilename, chTime);
        }
        else
        {
            sprintf(cFilename, "%s\\AIOPVideo_LOCAL_URL_COMPARISON_PIC[%s].txt", cFilename, chTime);
        }
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwComparisonPicBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_URL_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    ...
    if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 0)
    {
        sprintf(cFilename, "%s\\%s[AIOPVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_CompressDotMat_Pic[%s].jpg", cFilename, chTime);
        ...
        DWORD dwWrittenBytes = 0;
        DWORD dwRet = WriteFile(hFile, struHead.pCompressedDotMatrixBuff, struHead.dwCompressedDotMatrixBuffLen, &dwWrittenBytes, NULL);
        if (dwRet == 0 || dwWrittenBytes < struHead.dwCompressedDotMatrixBuffLen)
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwCompressedDotMatrixBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_CompressDotMat_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    else if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 1)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOPVideo_URL_CompressDotMat[%s].txt", cFilename, chTime);
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPVideo alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwCompressedDotMatrixBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_URL_CompressDotMat.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
}
...
void CClientDemoDlg::ProcAIOPPicture(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "%s:Time:%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d, AIOPDataSize:%d, Status:%d, byPictureMode:%d, MPID:%s PresetIndex[%d], PictureSize:%d, TaskID[%s]\n", \
        szLan, struHead.struTime.wYear, struHead.struTime.wMonth, struHead.struTime.wDay, \
        struHead.struTime.wHour, struHead.struTime.wMinute, struHead.struTime.wSecond, struHead.struTime.wMilliSec, \
        struHead.dwAIOPDataSize, struHead.byStatus, struHead.byPictureMode, struHead.szMPID, struHead.dwPresetIndex, struHead.dwPictureSize, struHead.szTaskID);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    ...
    if (struHead.dwAIOPDataSize > 0 && struHead.pBufferAIOPData != NULL)
    {
        ...
        AddLog(iDeviceIndex, ALARM_INFO_T, "AIOPPicture Receive AIOP_DATA file.Check in saved files");
    ...
    if (struHead.dwPictureSize > 0 && struHead.pBufferPicture != NULL&&struHead.byPictureMode == 0)
    {
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPicture alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwPictureSize, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "AIOPPicture Receive AIOP_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    else if (struHead.dwPictureSize > 0 && struHead.pBufferPicture != NULL&&struHead.byPictureMode == 1)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOPPicture_URL_PIC[%s].txt", cFilename, chTime);
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPicture alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwPictureSize, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "AIOPPicture Receive AIOP_URL_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    ...
    if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 0)
    {
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPicture alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwCompressedDotMatrixBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "AIOPPicture Receive AIOP_CompressDotMat_Pic.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    else if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 1)
    {
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPicture alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwCompressedDotMatrixBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "AIOPPicture Receive AIOP_URL_CompressDotMat.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
}
...
void CClientDemoDlg::ProcTrafficCollect(WPARAM wParam, LPARAM lParam)
{
    ...
    for (int i = 0; i < 6; ++i)
    {
        sprintf(szInfoBuf, "struDriveChan[%d]:byDriveChan[%d],wCarFlux[%d],wPasserbyFlux[%d],wShayFlux[%d],fAverOccpancy[%.3f],wAverSpeed[%d],wAverCarDis[%d]", \
...
void CClientDemoDlg::ProcessVcaDbdAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "%s uSize[%d],byChannel[%d],byLevel[%d],struIpcInfo{struDevIP[%s],wPort[%d],byChannel[%d]},\
                                       ...
                                       byDriverCmpFail[%d],byDriverChange[%d],byDriveLongTime[%d],byInfraredBlockingSunglasses[%d],byOutOfWheel[%d]}",
                                               szLan,
                                               ...
                                               struAlarmInfo.struAlarmState.byDriverCmpFail,
                                               struAlarmInfo.struAlarmState.byDriverChange,
                                               struAlarmInfo.struAlarmState.byDriveLongTime,
                                               struAlarmInfo.struAlarmState.byInfraredBlockingSunglasses,
                                               struAlarmInfo.struAlarmState.byOutOfWheel);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
...
void CClientDemoDlg::ProcessVcaAdasAlarm(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "%s uSize[%d],byChannel[%d],struIpcInfo{struDevIP[%s],wPort[%d],byChannel[%d]},\
                           ...
                           byAcc[%d],byBrake[%d],byTurn[%d],byRollover[%d],byNoCourtesy[%d],byTsr[%d]}",
                               szLan,
                               struAlarmInfo.dwSize,
                               struAlarmInfo.byChannel,
                               struAlarmInfo.struIpcInfo.struDevIP.sIpV4,
                               ...
                               struAlarmInfo.struAlarmState.byAcc,
                               struAlarmInfo.struAlarmState.byBrake,
                               struAlarmInfo.struAlarmState.byTurn,
                               struAlarmInfo.struAlarmState.byRollover,
                               struAlarmInfo.struAlarmState.byNoCourtesy,
                               struAlarmInfo.struAlarmState.byTsr);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);
    //保存图片和视频
    char cFilename[256] = { 0 };
    sprintf(cFilename, "%s\\%s", g_struLocalParam.chPictureSavePath, pAlarmDev->sDeviceIP);
...
void CClientDemoDlg::ProcessVcaAttendAlarm(WPARAM wParam, LPARAM lParam)
{
    char szInfoBuf[2048] = { 0 };
    LPLOCAL_ALARM_INFO pAlarmDev = (LPLOCAL_ALARM_INFO)(wParam);
    char *pAlarmInfo = (char *)(lParam);
    int iDeviceIndex = pAlarmDev->iDeviceIndex;
    char szLan[128] = { 0 };
    g_StringLanType(szLan, "VcaAttendAlarm", "VcaAttendAlarm");
    NET_DVR_VCA_ATTEND_ALARM_INFO  struAlarmInfo = { 0 };
    memset(&struAlarmInfo, 0, sizeof(struAlarmInfo));
    memcpy(&struAlarmInfo, pAlarmInfo, sizeof(struAlarmInfo));

    sprintf(szInfoBuf, "%s uSize[%d],byMethod[%d],byStatus[%d],byCertIDType[%d],byCertIDLen[%d],\
                        sCertId[%s],dwTime[%d],sName[%s],sAlarmIdNo[%s],\
                        struPicInfo{byPicNum[%d],dwVideoLen[%d]}",
                        szLan,
                        struAlarmInfo.dwSize,
                        struAlarmInfo.byMethod,
                        struAlarmInfo.byStatus,
                        struAlarmInfo.byCertIDType,
                        struAlarmInfo.byCertIDLen,
                        struAlarmInfo.sCertId,
                        struAlarmInfo.dwTime,
                        struAlarmInfo.sName,
                        struAlarmInfo.sAlarmIdNo,
                        struAlarmInfo.struPicInfo.byPicNum,
                        struAlarmInfo.struPicInfo.dwVideoLen);

    for (int i = 0; i < struAlarmInfo.struPicInfo.byPicNum; i++)
    {
        sprintf(szInfoBuf, "%s struPicInfo{struPicData[%d]dwPicLen[%d]", szInfoBuf, i, struAlarmInfo.struPicInfo.struPicData[i].dwPicLen);
    }
    ...
    for (int i = 0; i < struAlarmInfo.struPicInfo.byPicNum; i++)
    {
        if (struAlarmInfo.struPicInfo.struPicData[i].dwPicLen > 0 && struAlarmInfo.struPicInfo.struPicData[i].pPicBuf != NULL)
        {
            sprintf(cFilename, "%s\\VCA_Attend_[%d]_[%s].jpg", cFilename, i + 1, chTime);
            HANDLE hFile;
            DWORD dwReturn = 0;
            hFile = CreateFile(cFilename, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
            if (hFile != INVALID_HANDLE_VALUE)
            {
                WriteFile(hFile, struAlarmInfo.struPicInfo.struPicData[i].pPicBuf, struAlarmInfo.struPicInfo.struPicData[i].dwPicLen, &dwReturn, NULL);
                CloseHandle(hFile);
                hFile = NULL;
            }
        }
    ...
    if (struAlarmInfo.struPicInfo.dwVideoLen > 0 && struAlarmInfo.struPicInfo.pVideoBuf != NULL)
    {
        sprintf(cFilename, "%s\\VCA_Attend[%s].mp4", cFilename, chTime);
        HANDLE hFile;
        DWORD dwReturn = 0;
        hFile = CreateFile(cFilename, GENERIC_WRITE, FILE_SHARE_READ, NULL, CREATE_ALWAYS, FILE_ATTRIBUTE_NORMAL, NULL);
        if (hFile != INVALID_HANDLE_VALUE)
    ...
    for (int i = 0; i < struAlarmInfo.struPicInfo.byPicNum; i++)
    {
        if (struAlarmInfo.struPicInfo.struPicData[i].pPicBuf != NULL)
        {
            delete[]struAlarmInfo.struPicInfo.struPicData[i].pPicBuf;
            struAlarmInfo.struPicInfo.struPicData[i].pPicBuf = NULL;
        }
    }
...
void CClientDemoDlg::ProcessSubCribeEvent(WPARAM wParam, LPARAM lParam)
{
    ...
    g_StringLanType(szLan, "订阅信息返回(部分事件失败了会返回FailedEventList节点)：\n", "Subscribe event info:");
    char szInfoBuf[1024] = { 0 };
    sprintf(szInfoBuf, "%s%s", szLan, pAlarmInfo);
    szInfoBuf[strlen(szLan) + pAlarmDev->dwBufLen] = '\0';
    AddLog(iDeviceIndex, ALARM_INFO_T,  szInfoBuf);
...
void CClientDemoDlg::ProcAIOPPollingSnap(WPARAM wParam, LPARAM lParam)
{
    ...
    sprintf(szInfoBuf, "%s:Time:%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d, channel:%d,TaskID:%s, AIOPDataSize:%d, MPID:%s PresetIndex[%d]\r", \
        szLan, struHead.struTime.wYear, struHead.struTime.wMonth, struHead.struTime.wDay, \
        struHead.struTime.wHour, struHead.struTime.wMinute, struHead.struTime.wSecond, struHead.struTime.wMilliSec, \
    ...
    if (struHead.dwPictureSize > 0 && struHead.pBufferPicture != NULL)
    {
        sprintf(cFilename, "%s\\%s[AIOPPollingSnap]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        if (struHead.byPictureMode == 0)
        {
            sprintf(cFilename, "%s\\AIOP_POLLING_PICTURE[%s].jpg", cFilename, chTime);
        }
        else if (struHead.byPictureMode == 1)
        {
            sprintf(cFilename, "%s\\AIOPPollingSnap_URL_PIC[%s].txt", cFilename, chTime);
        }
        else
        {
            sprintf(cFilename, "%s\\AIOPPollingSnap_LOCAL_URL_PIC[%s].txt", cFilename, chTime);
        }
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPollingSnap alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwPictureSize, dwWrittenBytes);
        }
    ...
    if (struHead.dwAddInfoPictureSize > 0 && struHead.pAddInfoPictureBuffer != NULL&&struHead.byPictureMode == 0)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_POLLING_ADDINFO_PICTURE[%s].jpg", cFilename, chTime);
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPollingSnap alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwAddInfoPictureSize, dwWrittenBytes);
        }
    ...
    else if (struHead.dwAddInfoPictureSize > 0 && struHead.pAddInfoPictureBuffer != NULL&&struHead.byPictureMode == 1)
    {
        sprintf(cFilename, "%s\\%s[AIOPPollingSnap]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
        if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
        {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOPPollingSnap_URL_ADDINFO_PIC[%s].txt", cFilename, chTime);
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPollingSnap alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwAddInfoPictureSize, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_POLLING_URL_ADDINFO file.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
    ...
    if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 0)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_POLLING_CompressDotMat_PICTURE[%s].jpg", cFilename, chTime);
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPollingSnap alarm Write to File Fail.System Error:%d, PictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwCompressedDotMatrixBuffLen, dwWrittenBytes);
        }

        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_POLLING_CompressDotMat file.Check in saved files");
    ...
    else if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 1)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOPPollingSnap_URL_CompressDotMat_PIC[%s].txt", cFilename, chTime);
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPollingSnap alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwCompressedDotMatrixBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_POLLING_URL_CompressDotMat file.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
...
void CClientDemoDlg::ProcAIOPPollingVideo(WPARAM wParam, LPARAM lParam)
{
    ...
    if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 0)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOP_POLLING_VIDEO_CompressDonMat[%s].jpg", cFilename, chTime);
        ...
        {
            DWORD dwError = GetLastError();
            g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPPollingVideo alarm Write to File Fail.System Error:%d, dwCompressedDotMatrixBuffLen:%d, WrittenBytes:%d ", dwError, struHead.dwCompressedDotMatrixBuffLen, dwWrittenBytes);
        }
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_POLLING_VIDEO_CompressDonMat file.Check in saved files");
    ...
    else if (struHead.dwCompressedDotMatrixBuffLen > 0 && struHead.pCompressedDotMatrixBuff != NULL&&struHead.byCompressedDotMatrixMode == 1)
    {
        ...
        char chTime[128];
        sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
        sprintf(cFilename, "%s\\AIOPPollingVideo_URL_CompressDonMat_PIC[%s].txt", cFilename, chTime);
        ...
        AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_DATA_CompressDonMat file.Check in saved files");
        CloseHandle(hFile);
        hFile = NULL;
    }
}

void CClientDemoDlg::ProcAIOPHistoryVideo(WPARAM wParam, LPARAM lParam)
{
	char szInfoBuf[1024] = { 0 };
	char szLan[128] = { 0 };
	char cFilename[256] = { 0 };
	...
	int iDeviceIndex = pAlarmDev->iDeviceIndex;
	DWORD dwBufLen = pAlarmDev->dwBufLen;
	NET_AIOP_HISTORY_VIDEO_HEAD struHead = { 0 };
	memset(&struHead, 0, sizeof(NET_AIOP_HISTORY_VIDEO_HEAD));
	memcpy(&struHead, pAlarmInfo, sizeof(NET_AIOP_HISTORY_VIDEO_HEAD));


	g_StringLanType(szLan, "AI开放平台接入，上传历史视频检测数据", "AIOP_HISTORY_VIDEO");
	sprintf(szInfoBuf, "%s:Time:%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d, channel:%d, TaskID:%s,AIOPDataSize:%d, PictureSize:%d, MPID:%s\n", \
		szLan, struHead.struTime.wYear, struHead.struTime.wMonth, struHead.struTime.wDay, \
		struHead.struTime.wHour, struHead.struTime.wMinute, struHead.struTime.wSecond, struHead.struTime.wMilliSec, \
		struHead.dwChannel, struHead.szTaskID, struHead.dwAIOPDataSize, struHead.dwPictureSize, struHead.szMPID);
	AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);

	if (struHead.dwAIOPDataSize > 0 && struHead.pBufferAIOPData != NULL)
	{
		sprintf(cFilename, "%s\\%s[AIOPHistoryVideo]", g_struLocalParam.chPictureSavePath, g_struDeviceInfo[iDeviceIndex].chDeviceIPInFileName);
		if (GetFileAttributes(cFilename) != FILE_ATTRIBUTE_DIRECTORY)
		{
			CreateDirectory(cFilename, NULL);
		}
		...
		{
			DWORD dwError = GetLastError();
			g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPHistoryVideo alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwAIOPDataSize, dwWrittenBytes);
		}
		AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_DATA file.Check in saved files");
		CloseHandle(hFile);
		hFile = NULL;
	...
	if (struHead.dwPictureSize > 0 && struHead.pBufferPicture != NULL&&struHead.byPictureMode == 0)
	{
		...
		{
			DWORD dwError = GetLastError();
			g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPHistoryVideo alarm Write to File Fail.System Error:%d, AIOPHistoryPictureSize:%d, WrittenBytes:%d ", dwError, struHead.dwPictureSize, dwWrittenBytes);
		}
		AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_HISTORY_VIDEO file.Check in saved files");
	...
	else if (struHead.dwPictureSize > 0 && struHead.pBufferPicture != NULL&&struHead.byPictureMode == 1)
	{
		...
		char chTime[128];
		sprintf(chTime, "%4.4d%2.2d%2.2d%2.2d%2.2d%2.2d%3.3d", t.wYear, t.wMonth, t.wDay, t.wHour, t.wMinute, t.wSecond, t.wMilliseconds);
		sprintf(cFilename, "%s\\AIOPHistoryVideo_URL_PIC[%s].txt", cFilename, chTime);
		...
		{
			DWORD dwError = GetLastError();
			g_pMainDlg->AddLog(iDeviceIndex, OPERATION_FAIL_T, "AIOPHistoryVideo alarm Write to File Fail.System Error:%d, AIOPDataSize:%d, WrittenBytes:%d ", dwError, struHead.dwPictureSize, dwWrittenBytes);
		}
		AddLog(iDeviceIndex, ALARM_INFO_T, "Receive AIOP_DATA file.Check in saved files");
		CloseHandle(hFile);
		hFile = NULL;
...
void CClientDemoDlg::ProcAlarmException(WPARAM wParam, LPARAM lParam)
{
    char szInfoBuf[1024] = { 0 };
    char szLan[128] = { 0 };
    char cFilename[256] = { 0 };
    ...
    int iDeviceIndex = pAlarmDev->iDeviceIndex;
    DWORD dwBufLen = pAlarmDev->dwBufLen;
    NET_ALARM_EXCEPTION struArmExce = { 0 };
    memset(&struArmExce, 0, sizeof(NET_ALARM_EXCEPTION));
    memcpy(&struArmExce, pAlarmInfo, sizeof(NET_ALARM_EXCEPTION));


    g_StringLanType(szLan, "报警异常", "ALARM_EXCEPTION");
    sprintf(szInfoBuf, "[%s] dwAlarmType[0x%x], byExceptionType[%d], szErrMsg[%s]", \
        szLan, struArmExce.dwAlarmType, struArmExce.byExceptionType, struArmExce.szErrMsg);
    AddLog(iDeviceIndex, ALARM_INFO_T, szInfoBuf);

    return;
}

int CClientDemoDlg::GetAlarmNum()
{
    if (m_iAlarmNum > 100)
    {
        m_iAlarmNum =0;
